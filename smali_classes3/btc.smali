...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, Lbtc;->b:J

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lbtc;->c:Ljava/util/ArrayList;
...
# virtual methods
.method public abstract a(Lysc;Lbj;)I
.end method
...
.method public final j(I)Ljava/nio/ByteBuffer;
    ...
    invoke-direct {v2, v3, v0}, Las;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    invoke-direct {v1, v2}, Lulb;-><init>(I)V

    iget-object p1, p0, Lbtc;->c:Ljava/util/ArrayList;

    invoke-virtual {p1, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v1, v0}, Lulb;->g(Ljava/nio/ByteBuffer;)V
...
.method public abstract l()Lhf5;
.end method

.method public m()Ljava/lang/Long;
    .locals 4

    iget-wide v0, p0, Lbtc;->b:J
...
.method public abstract s(Ljava/nio/ByteBuffer;Lhc;JLbh8;I)V
.end method

.method public final t(Ljava/nio/ByteBuffer;BILhc;JLbh8;)V
    .locals 22
    ...
    :goto_1
    invoke-virtual {v0, v2}, Lbtc;->v(B)V
    ...
    invoke-interface {v5, v7}, Lbh8;->decrypted(Ljava/lang/String;)V
    ...
    invoke-interface {v5, v7, v9}, Lbh8;->encrypted(Ljava/lang/String;[B)V
    ...
    invoke-interface {v5, v1, v6}, Lbh8;->encrypted(Ljava/lang/String;[B)V

    iget-wide v7, v0, Lbtc;->b:J
    ...
    iget-short v7, v7, Lrwe;->g:S

    move-object v8, v4

    check-cast v8, Lkc;

    iget-object v12, v8, Lkc;->b:Lbh8;
    ...
    invoke-interface {v12, v7, v13}, Lbh8;->secret(Ljava/lang/String;[B)V
    ...
    invoke-interface {v12, v7}, Lbh8;->info(Ljava/lang/String;)V
    ...
    invoke-interface {v5, v3, v1}, Lbh8;->decrypted(Ljava/lang/String;[B)V

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, v0, Lbtc;->c:Ljava/util/ArrayList;
    ...
    iget-object v7, v0, Lbtc;->c:Ljava/util/ArrayList;

    new-instance v8, Ldlf;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v8, v1, v5}, Ldlf;->h(Ljava/nio/ByteBuffer;Lbh8;)V
    ...
    invoke-virtual {v8, v1}, Lg07;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Lir3;->j(Ljava/nio/ByteBuffer;)V
    ...
    new-instance v8, Lyob;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v8, v1}, Lyob;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Lqob;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v1}, Latc;->e(Ljava/nio/ByteBuffer;)I
    ...
    invoke-virtual {v8, v1}, Lqga;->h(Ljava/nio/ByteBuffer;)V
    ...
    new-instance v8, Lemf;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v8, v1}, Lemf;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v8, v9}, Lmr8;-><init>(I)V

    invoke-virtual {v8, v1}, Lmr8;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v1}, Lepi;->i(Ljava/nio/ByteBuffer;)J

    move-result-wide v9

    iput-wide v9, v8, Lzd4;->b:J
    ...
    invoke-virtual {v8, v1}, Lnr8;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Lmr8;->j(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1, v5}, Lfha;->h(Ljava/nio/ByteBuffer;Lbh8;)V
    ...
    invoke-virtual {v8, v1, v5}, Lya4;->h(Ljava/nio/ByteBuffer;Lbh8;)V
    ...
    invoke-virtual {v8, v1}, Lmr8;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Lsnd;->h(Ljava/nio/ByteBuffer;)V
    ...
    iput-object v9, v8, Lz5;->X:Ljava/lang/String;

    invoke-virtual {v8, v1, v5}, Lz5;->i(Ljava/nio/ByteBuffer;Lbh8;)V
    ...
    new-instance v8, Lulb;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v8, v1}, Lulb;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Lef4;->h(Ljava/nio/ByteBuffer;)V
    ...
    :cond_b
    invoke-virtual {v0, v2}, Lbtc;->d(B)V
    ...
    invoke-interface {v5, v1}, Lbh8;->error(Ljava/lang/String;)V
...
.method public final u(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Lhc;)V
    ...
    iget-wide v5, v0, Lbtc;->b:J

    invoke-static {v5, v6}, Lbtc;->f(J)[B
