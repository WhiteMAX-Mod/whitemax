...
.method public constructor <init>(Lzzg;)V
    ...
    iput-object p1, p0, Ldtc;->d:Llig;

    return-void
.end method

.method public constructor <init>(Lzzg;Llig;)V
    .locals 0
...
.method public static c(IJLjava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, p3}, Lepi;->b(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {p1, p2, p3}, Lepi;->c(JLjava/nio/ByteBuffer;)I
...
.method public static d(ILjava/nio/ByteBuffer;[B)V
    ...
    invoke-static {p0, p1}, Lepi;->b(ILjava/nio/ByteBuffer;)I
...
.method public final a()[B
    ...
    sget-object v2, Lzzg;->b:Lzzg;

    iget-object v3, p0, Ldtc;->a:Lzzg;

    invoke-virtual {v3, v2}, Lzzg;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v3}, Lzzg;->b()Z
    ...
    iget-object v4, p0, Ldtc;->d:Llig;

    if-ne v3, v2, :cond_2

    iget-object v5, v4, Llig;->a:[B

    invoke-static {v0, v1, v5}, Ldtc;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_2
    iget-wide v5, v4, Llig;->b:J

    const/4 v7, 0x1

    invoke-static {v7, v5, v6, v1}, Ldtc;->c(IJLjava/nio/ByteBuffer;)V

    if-ne v3, v2, :cond_3

    iget-object v5, v4, Llig;->q:[B

    if-eqz v5, :cond_3

    invoke-static {v2, v1, v5}, Ldtc;->d(ILjava/nio/ByteBuffer;[B)V
    ...
    iget-wide v5, v4, Llig;->c:J

    const/4 v7, 0x4

    invoke-static {v7, v5, v6, v1}, Ldtc;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Llig;->d:J

    const/4 v8, 0x5

    invoke-static {v8, v5, v6, v1}, Ldtc;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Llig;->e:J

    const/4 v8, 0x6

    invoke-static {v8, v5, v6, v1}, Ldtc;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Llig;->f:J

    const/4 v8, 0x7

    invoke-static {v8, v5, v6, v1}, Ldtc;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Llig;->g:J

    const/16 v8, 0x8

    invoke-static {v8, v5, v6, v1}, Ldtc;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Llig;->h:J
    ...
    iget-boolean v5, v4, Llig;->j:Z

    if-eqz v5, :cond_4

    const/16 v5, 0xc

    invoke-static {v5, v1}, Lepi;->b(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {v0, v5, v6, v1}, Ldtc;->c(IJLjava/nio/ByteBuffer;)V

    iget-object v0, v4, Llig;->n:[B

    const/16 v5, 0xf

    invoke-static {v5, v1, v0}, Ldtc;->d(ILjava/nio/ByteBuffer;[B)V

    if-ne v3, v2, :cond_5

    iget-object v0, v4, Llig;->o:[B

    if-eqz v0, :cond_5

    const/16 v3, 0x10

    invoke-static {v3, v1, v0}, Ldtc;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_5
    iget-object v0, v4, Llig;->r:Lenb;
    ...
    invoke-direct {v0, v6, v5}, Las;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    invoke-static {v0, v3, v4, v1}, Ldtc;->c(IJLjava/nio/ByteBuffer;)V
...
.method public final e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Lbh8;)V
    .locals 11
    ...
    invoke-static {p1}, Lepi;->f(Ljava/nio/ByteBuffer;)I
    ...
    invoke-interface {p3, v1, v0}, Lbh8;->debug(Ljava/lang/String;[B)V

    iput-object v0, v6, Llig;->a:[B
    ...
    invoke-interface {p3, v2}, Lbh8;->debug(Ljava/lang/String;)V

    iput-wide v0, v6, Llig;->b:J
    ...
    invoke-interface {p3, v1}, Lbh8;->debug(Ljava/lang/String;)V

    iput-object v0, v6, Llig;->q:[B
    ...
    invoke-interface {p3, v0}, Lbh8;->debug(Ljava/lang/String;)V

    iput-boolean v5, v6, Llig;->j:Z
    ...
    iput-object v0, p3, Lka5;->a:Ljava/lang/Object;
    ...
    iput-object v0, p3, Lka5;->b:Ljava/lang/Object;
    ...
    iget-object v0, p3, Lka5;->a:Ljava/lang/Object;

    check-cast v0, Ljava/net/InetAddress;

    if-nez v0, :cond_14

    iget-object v0, p3, Lka5;->b:Ljava/lang/Object;
    ...
    iput-object v0, p3, Lka5;->c:Ljava/lang/Object;
    ...
    invoke-direct {v2, v1}, Lzzg;-><init>(I)V
    ...
    invoke-direct {v2, p3}, Lzzg;-><init>(I)V

    const/16 p3, 0xe

    invoke-direct {v1, v2, p3, v0}, Lenb;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v1, v6, Llig;->r:Lenb;
    ...
    :goto_a
    invoke-interface {p3, v0}, Lbh8;->warn(Ljava/lang/String;)V
