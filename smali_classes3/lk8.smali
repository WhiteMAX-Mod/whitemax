...
# direct methods
.method public constructor <init>(Ljava/time/Clock;Llhd;Lxud;Lyga;Lghd;Lvqc;)V
    .locals 2
    ...
    iput-wide v0, p0, Llk8;->i:J

    iput-object p1, p0, Llk8;->a:Ljava/time/Clock;

    iput-object p2, p0, Llk8;->b:Llhd;

    iput-object p3, p0, Llk8;->c:Lxud;

    iput-object p4, p0, Llk8;->d:Lyga;

    iput-object p5, p0, Llk8;->e:Lghd;

    iput-object p6, p0, Llk8;->f:Lvqc;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, Llk8;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Llk8;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final declared-synchronized a()V
    ...
    :try_start_0
    iget-object v0, p0, Llk8;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Llk8;->d:Lyga;

    invoke-virtual {v1, v0}, Lyga;->b(Ljava/util/List;)V

    iget-object v0, p0, Llk8;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Llk8;->j:Ljava/time/Instant;

    iput-object v0, p0, Llk8;->k:Ljava/time/Instant;

    const/4 v0, 0x1

    iput-boolean v0, p0, Llk8;->l:Z
    :try_end_0
...
.method public final b()V
    ...
    :cond_0
    iget-object v0, p0, Llk8;->c:Lxud;

    invoke-virtual {v0}, Lxud;->b()I

    move-result v0

    iget-object v1, p0, Llk8;->c:Lxud;
    ...
    iget-object v1, p0, Llk8;->a:Ljava/time/Clock;
    ...
    iget-object v1, p0, Llk8;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v4, p0, v5, v0}, Lcn4;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v5, p0, Llk8;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v5, p0, v6}, Ljk8;-><init>(Llk8;I)V

    invoke-interface {v4, v5}, Ljava/util/stream/Stream;->forEach(Ljava/util/function/Consumer;)V

    iget-object v4, p0, Llk8;->e:Lghd;

    invoke-virtual {v4}, Lghd;->run()V

    iget-object v4, p0, Llk8;->d:Lyga;
    ...
    iget-wide v9, v4, Lyga;->b:J

    sub-long/2addr v9, v7

    iput-wide v9, v4, Lyga;->b:J

    iget-object v9, v4, Lyga;->d:Lrde;

    invoke-virtual {v9}, Lrde;->k()V
    ...
    invoke-virtual {v4}, Lyga;->a()V

    iget-object v7, v4, Lyga;->a:Lbh8;

    iget-wide v8, v4, Lyga;->b:J
    ...
    invoke-interface {v7, v6}, Lbh8;->debug(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {v6, v7}, Lov5;-><init>(I)V
    ...
    iget-object v6, v4, Lyga;->f:Ljava/time/Instant;
    ...
    iput-object v5, v4, Lyga;->f:Ljava/time/Instant;

    iget-wide v5, v4, Lyga;->c:J
    ...
    iput-wide v7, v4, Lyga;->c:J

    :cond_2
    iget-object v5, v4, Lyga;->a:Lbh8;

    iget-wide v6, v4, Lyga;->c:J
    ...
    invoke-interface {v5, v6}, Lbh8;->cc(Ljava/lang/String;)V

    iget-wide v5, v4, Lyga;->c:J

    iput-wide v5, v4, Lyga;->e:J

    :cond_3
    iget-object v4, v4, Lyga;->a:Lbh8;

    invoke-interface {v4}, Lbh8;->getQLog()Lvqc;
    ...
    invoke-direct {v4, p0, v5}, Ljk8;-><init>(Llk8;I)V
    ...
    invoke-direct {v4, p0, v5}, Lik8;-><init>(Llk8;I)V
    ...
    invoke-direct {v4, v5}, Lov5;-><init>(I)V
