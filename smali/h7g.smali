...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iget-object p1, p1, Lh5b;->a:Ljava/lang/String;

    new-instance v0, Lg7g;

    const/4 v1, 0x0

    invoke-direct {v0, p1, p0, v1}, Lg7g;-><init>(Ljava/lang/Object;Lh7g;I)V

    iput-object v0, p0, Lh7g;->a:Lg7g;
    ...
    invoke-direct {p0}, Lh7g;->getTheme()Lyeb;
    ...
    iput-object p1, p0, Lh7g;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-interface {v2}, Lyeb;->i()Lgnf;
    ...
    iput-object v0, p0, Lh7g;->d:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lh7g;->o:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lh7g;->s0:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lh7g;->t0:Landroid/graphics/RectF;
...
.method public static final synthetic a(Lh7g;)Lyeb;
    .locals 0
...
.method private final getTheme()Lyeb;
    .locals 3
    ...
    invoke-virtual {p0}, Lh7g;->getThemeName()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lafb;->a(Ljava/lang/String;)Lh5b;
    ...
    invoke-virtual {v1, v2}, Lh5b;->a(Z)Lyeb;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lh7g;->getIncomingColors()[I
    ...
    iput-object v3, v0, Lh7g;->u0:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Lh7g;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Lh7g;->v0:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Lh7g;->w0:[Lyy7;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Lh7g;->c:Lg7g;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v10, p0, Lh7g;->d:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Lh7g;->s0:Landroid/graphics/RectF;

    invoke-virtual {v5, p1, v1, v6, v8}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lh7g;->u0:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Lh7g;->o:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Lh7g;->t0:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v8, v5, v2}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lh7g;->v0:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(Lyeb;)V
    ...
    :goto_0
    iget-object v0, p0, Lh7g;->d:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lh7g;->b:Landroid/graphics/drawable/GradientDrawable;
