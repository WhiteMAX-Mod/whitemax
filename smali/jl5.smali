...
# direct methods
.method public constructor <init>(Lggg;Lzt;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ljl5;->b:Lggg;

    iput-object p2, p0, Ljl5;->a:Lzt;
...
.method public final L0(Landroidx/media3/common/PlaybackException;)V
    ...
    :cond_0
    sget-object v0, Landroidx/media3/transformer/ExportException;->b:Lyjd;
    ...
    invoke-virtual {v0, v1}, Lyjd;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v1, p1}, Lzt;->c(Landroidx/media3/transformer/ExportException;)V
...
.method public final e0(Lkgg;)V
    ...
    iget-object v0, p0, Ljl5;->a:Lzt;

    const/4 v1, 0x1

    :try_start_0
    invoke-virtual {p1, v1}, Lkgg;->a(I)Z

    move-result v2

    const/4 v3, 0x2

    invoke-virtual {p1, v3}, Lkgg;->a(I)Z
    ...
    invoke-static {v4, v6, v5}, Lwy1;->p(ILjava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    :cond_3
    iget-object p1, p0, Ljl5;->b:Lggg;

    if-lez v2, :cond_4

    :try_start_1
    invoke-interface {v0, v2}, Lzt;->a(I)V

    iget-object p1, p1, Lggg;->c:Ljava/lang/Object;

    check-cast p1, Lem5;

    invoke-virtual {p1}, Li3;->play()V
    ...
    iget-object v3, p1, Lggg;->d:Ljava/lang/Object;
    ...
    invoke-static {v3, p1}, Ltfi;->c(Landroid/content/Context;Lk09;)Ljava/lang/String;
...
.method public final n0(Ls9g;I)V
    ...
    iget-object p2, p0, Ljl5;->a:Lzt;

    iget-object v0, p0, Ljl5;->b:Lggg;
    ...
    invoke-interface {p2, v1, v2}, Lzt;->d(J)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
