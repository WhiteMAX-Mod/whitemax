...
# direct methods
.method public static a(Landroid/hardware/camera2/CaptureRequest$Builder;Lfjb;)V
    .locals 4
    ...
    invoke-interface {p1}, Lebd;->e()Ljava/util/Set;
    ...
    iget-object v2, v1, Ls90;->c:Ljava/lang/Object;
    ...
    invoke-static {v2, v1}, Lgri;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static b(Landroid/hardware/camera2/CaptureRequest$Builder;ILcs0;)V
    .locals 1
...
.method public static c(Lh52;Landroid/hardware/camera2/CameraDevice;Ljava/util/HashMap;ZLcs0;)Landroid/hardware/camera2/CaptureRequest;
    .locals 9
    ...
    :cond_0
    iget-object v0, p0, Lh52;->a:Ljava/util/ArrayList;

    iget-object v1, p0, Lh52;->b:Lfjb;

    iget v2, p0, Lh52;->c:I

    iget-object v3, v1, Lfjb;->a:Ljava/util/TreeMap;
    ...
    invoke-interface {p2}, Lr02;->s()Landroid/hardware/camera2/CaptureResult;
    ...
    invoke-static {v6, p3}, Lgri;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, p2}, Lgri;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_3
    invoke-static {p1, v2, p4}, Lmxi;->b(Landroid/hardware/camera2/CaptureRequest$Builder;ILcs0;)V

    sget-object p2, Lh52;->k:Ls90;

    sget-object p3, Lob0;->f:Landroid/util/Range;

    :try_start_0
    invoke-virtual {v1, p2}, Lfjb;->f(Ls90;)Ljava/lang/Object;
    ...
    sget-object p2, Lob0;->f:Landroid/util/Range;
    ...
    sget-object p4, Lh52;->k:Ls90;

    :try_start_1
    invoke-virtual {v1, p4}, Lfjb;->f(Ls90;)Ljava/lang/Object;
    ...
    :cond_7
    invoke-virtual {p0}, Lh52;->b()I

    move-result p2

    if-eq p2, v5, :cond_a

    invoke-virtual {p0}, Lh52;->c()I
    ...
    :cond_d
    invoke-static {p1, v1}, Lmxi;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Lfjb;)V
...
.method public static d(Lh52;Landroid/hardware/camera2/CameraDevice;Lcs0;)Landroid/hardware/camera2/CaptureRequest;
    .locals 3
    ...
    invoke-static {p1, v1, p2}, Lmxi;->b(Landroid/hardware/camera2/CaptureRequest$Builder;ILcs0;)V

    iget-object p0, p0, Lh52;->b:Lfjb;

    invoke-static {p1, p0}, Lmxi;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Lfjb;)V
