...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean p1, Lp0e;->a:Z

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    iput-object v0, p0, Leha;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final b(Ljava/lang/Runnable;)Lpy4;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Leha;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lpy4;
...
.method public final dispose()V
    ...
    iput-boolean v0, p0, Leha;->b:Z

    iget-object v0, p0, Leha;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lqy4;)Lnzd;
    .locals 3

    new-instance v0, Lnzd;

    invoke-direct {v0, p1, p5}, Lnzd;-><init>(Ljava/lang/Runnable;Lqy4;)V

    if-eqz p5, :cond_0

    invoke-interface {p5, v0}, Lqy4;->a(Lpy4;)Z
    ...
    iget-object v1, p0, Leha;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    :goto_0
    invoke-virtual {v0, p1}, Lnzd;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    invoke-interface {p5, v0}, Lqy4;->b(Lpy4;)Z
