...
.method public static e(Ljava/util/ArrayList;I)Lzka;
    .locals 19
    ...
    invoke-static {v0}, Lala;->g(Landroid/app/Notification$Action;)[Landroid/app/RemoteInput;
    ...
    invoke-static {v7}, Lala;->h(Landroid/app/RemoteInput;)Ljava/lang/String;

    move-result-object v9

    invoke-static {v7}, Lala;->f(Landroid/app/RemoteInput;)Ljava/lang/CharSequence;

    move-result-object v10

    invoke-static {v7}, Lala;->b(Landroid/app/RemoteInput;)[Ljava/lang/CharSequence;

    move-result-object v11

    invoke-static {v7}, Lala;->a(Landroid/app/RemoteInput;)Z
    ...
    invoke-static {v7}, Lfla;->c(Landroid/app/RemoteInput;)I
    ...
    :goto_1
    invoke-static {v7}, Lala;->d(Landroid/app/RemoteInput;)Landroid/os/Bundle;

    move-result-object v14

    const/4 v15, 0x0

    invoke-direct/range {v8 .. v15}, Lpkd;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/CharSequence;ZILandroid/os/Bundle;Ljava/util/HashSet;)V
    ...
    invoke-static {v0}, Lala;->c(Landroid/app/Notification$Action;)Landroid/os/Bundle;
    ...
    invoke-static {v0}, Ldla;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lela;->a(Landroid/app/Notification$Action;)I
    ...
    invoke-static {v0}, Lfla;->e(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lgla;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lcla;->a(Landroid/app/Notification$Action;)Landroid/graphics/drawable/Icon;
    ...
    invoke-direct/range {v7 .. v18}, Lzka;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Lpkd;[Lpkd;ZIZZZ)V
    ...
    invoke-static {v1}, Lob7;->d(Ljava/lang/Object;)I
    ...
    invoke-static {v1}, Lob7;->b(Ljava/lang/Object;)I
