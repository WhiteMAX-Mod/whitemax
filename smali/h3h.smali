...
.method public constructor <init>(Lf3h;)V
    ...
    iput-object v0, p0, Lh3h;->d:Ljava/util/HashSet;

    iput-object p1, p0, Lh3h;->a:Lf3h;

    invoke-interface {p1}, Lf3h;->H()I
    ...
    iput-object v1, p0, Lh3h;->b:Landroid/util/Range;

    invoke-interface {p1}, Lf3h;->U()I
    ...
    iput-object p1, p0, Lh3h;->c:Landroid/util/Range;
...
.method public static a(Lf3h;Landroid/util/Size;)Lf3h;
    .locals 4
    ...
    invoke-interface {p0, v0, v1}, Lf3h;->b(II)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-interface {p0}, Lf3h;->V()Landroid/util/Range;

    move-result-object v0

    invoke-interface {p0}, Lf3h;->Y()Landroid/util/Range;
    ...
    invoke-direct {v0, p0}, Lh3h;-><init>(Lf3h;)V
    ...
    iget-object v0, v0, Lh3h;->d:Ljava/util/HashSet;
...
.method public final Q(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lh3h;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Lh3h;->a:Lf3h;
    ...
    invoke-static {p1, v0}, Lz5j;->a(Ljava/lang/String;Z)V

    iget-object p1, p0, Lh3h;->b:Landroid/util/Range;
...
.method public final T(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lh3h;->b:Landroid/util/Range;
    ...
    iget-object p1, p0, Lh3h;->c:Landroid/util/Range;
...
.method public final V()Landroid/util/Range;
    ...
    iget-object v0, p0, Lh3h;->b:Landroid/util/Range;
...
.method public final W(II)Z
    ...
    invoke-interface {v0, p1, p2}, Lf3h;->W(II)Z
    ...
    :cond_0
    iget-object v1, p0, Lh3h;->d:Ljava/util/HashSet;
...
.method public final Y()Landroid/util/Range;
    ...
    iget-object v0, p0, Lh3h;->c:Landroid/util/Range;
