...
.method public j0(Llie;)V
    ...
    iget-object p1, p1, Llie;->a:Lkie;

    invoke-interface {p1}, Lkie;->e()Landroid/hardware/camera2/CameraCaptureSession$StateCallback;

    move-result-object v1

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {p1}, Lkie;->f()Ljava/util/List;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-interface {p1}, Lkie;->c()Ljava/util/concurrent/Executor;
    ...
    iget-object v3, v3, Lekb;->a:Lgkb;

    invoke-virtual {v3}, Lgkb;->b()Ljava/lang/String;
    ...
    invoke-static {v6, v2, v4, v3, v5}, Lwy1;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string v4, "CameraDeviceCompat"

    invoke-static {v4, v3}, Lgri;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, v3}, Ly02;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;)V
    ...
    iget-object v3, v3, La22;->a:Landroid/os/Handler;

    invoke-interface {p1}, Lkie;->b()Lim7;
    ...
    :try_start_0
    iget-object p1, v4, Lim7;->a:Lgm7;

    iget-object p1, p1, Lgm7;->a:Landroid/hardware/camera2/params/InputConfiguration;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v2}, Llie;->a(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v4, v4, Lekb;->a:Lgkb;

    invoke-virtual {v4}, Lgkb;->c()Landroid/view/Surface;
