...
.method public constructor <init>(Landroid/os/Bundle;)V
    ...
    .line 4
    iput-object p1, p0, Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;->C0:Lk18;
...
.method public final L0(Landroid/view/LayoutInflater;Landroid/widget/FrameLayout;)Landroid/view/View;
    ...
    iget-object v6, p0, Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;->C0:Lk18;
    ...
    iget-object v7, v6, Lfq3;->c:Lqv1;

    invoke-virtual {v7}, Lqv1;->e()Lmcf;
    ...
    iget-object v7, v7, Lonb;->c:Ljava/util/Map;

    iget-object v6, v6, Lfq3;->b:Lzi1;
    ...
    invoke-virtual {v1, v6}, Lone/me/sdk/uikit/common/button/OneMeButton;->setSize(Ljza;)V
    ...
    invoke-direct {v8, p0, v9}, Leq3;-><init>(Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;I)V
    ...
    invoke-virtual {v8, v3}, Lone/me/sdk/uikit/common/button/OneMeButton;->setAppearance(Lgza;)V

    invoke-virtual {v8, v6}, Lone/me/sdk/uikit/common/button/OneMeButton;->setSize(Ljza;)V

    sget-object v2, Liza;->b:Liza;

    invoke-virtual {v8, v2}, Lone/me/sdk/uikit/common/button/OneMeButton;->setMode(Liza;)V
    ...
    invoke-direct {v0, p0, v2}, Leq3;-><init>(Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;I)V
    ...
    invoke-virtual {v0, v2, v3, v5, v3}, Lut3;->d(IIII)V

    const/4 v6, 0x7

    invoke-virtual {v0, v2, v6, v5, v6}, Lut3;->d(IIII)V

    const/4 v7, 0x6

    invoke-virtual {v0, v2, v7, v5, v7}, Lut3;->d(IIII)V
    ...
    invoke-virtual {v0, v2, v10, v9, v3}, Lut3;->d(IIII)V

    new-instance v9, Lfua;

    const/4 v11, 0x5

    invoke-direct {v9, v0, v10, v2, v11}, Lfua;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v9, v11}, Lfua;->e(I)V

    invoke-virtual {v0, v2}, Lut3;->g(I)Lpt3;
    ...
    invoke-virtual {v0, v2, v3, p1, v10}, Lut3;->d(IIII)V
    ...
    invoke-virtual {v0, v2, v10, p1, v3}, Lut3;->d(IIII)V

    new-instance p1, Lfua;

    const/4 v9, 0x5

    invoke-direct {p1, v0, v10, v2, v9}, Lfua;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {p1, v2}, Lfua;->e(I)V
    ...
    invoke-virtual {v0, p1, v3, v2, v10}, Lut3;->d(IIII)V

    invoke-virtual {v8}, Landroid/view/View;->getId()I

    move-result v2

    invoke-virtual {v0, p1, v6, v2, v7}, Lut3;->d(IIII)V

    new-instance v2, Lfua;

    const/4 v4, 0x5

    invoke-direct {v2, v0, v6, p1, v4}, Lfua;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v0, p1, v7, v5, v7}, Lut3;->d(IIII)V

    invoke-virtual {v0, p1, v10, v5, v3}, Lut3;->d(IIII)V
    ...
    invoke-virtual {v0, p1, v3, v2, v3}, Lut3;->d(IIII)V

    invoke-virtual {v0, p1, v6, v5, v6}, Lut3;->d(IIII)V

    invoke-virtual {v1}, Landroid/view/View;->getId()I

    move-result v2

    invoke-virtual {v0, p1, v7, v2, v6}, Lut3;->d(IIII)V
    ...
    invoke-virtual {v2, v3}, Lfua;->e(I)V

    invoke-virtual {v1}, Landroid/view/View;->getId()I

    move-result v1

    invoke-virtual {v0, p1, v10, v1, v10}, Lut3;->d(IIII)V
...
.method public final onViewCreated(Landroid/view/View;)V
    ...
    iget-object p1, p0, Lone/me/sdk/bottomsheet/BottomSheetWidget;->x0:Lr35;

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lone/me/calls/ui/bottomsheet/opponent/ConfirmRemoveOpponentToCallBottomSheet;->C0()Lyeb;

    move-result-object v0

    invoke-virtual {p1, v0}, Lr35;->setCustomTheme(Lyeb;)V
