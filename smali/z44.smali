...
.method public synthetic constructor <init>(ILjava/lang/Object;)V
    ...
    iput-object p2, p0, Lz44;->e:Ljava/lang/Object;
...
.method public constructor <init>(Lone/me/startconversation/StartConversationScreen;Z)V
    ...
    .line 3
    invoke-direct {p0, p2}, Lbva;-><init>(Z)V

    return-void
.end method

.method public constructor <init>(ZLem6;)V
    .locals 1
...
.method public a()V
    ...
    :pswitch_0
    iget-object v0, p0, Lz44;->e:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v1, v0, Landroidx/fragment/app/c;->h:Lue0;

    if-eqz v1, :cond_2

    const/4 v2, 0x0

    iput-boolean v2, v1, Lue0;->r:Z

    new-instance v3, Lgq5;

    const/4 v4, 0x5

    invoke-direct {v3, v4, v0}, Lgq5;-><init>(ILjava/lang/Object;)V

    iget-object v4, v1, Lue0;->p:Ljava/util/ArrayList;
    ...
    iput-object v4, v1, Lue0;->p:Ljava/util/ArrayList;

    :cond_1
    iget-object v1, v1, Lue0;->p:Ljava/util/ArrayList;

    invoke-virtual {v1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Landroidx/fragment/app/c;->h:Lue0;

    invoke-virtual {v1, v2}, Lue0;->d(Z)I
    ...
    iput-object v1, v0, Landroidx/fragment/app/c;->h:Lue0;
...
.method public final b()V
    ...
    iget-object v3, p0, Lz44;->e:Ljava/lang/Object;

    packed-switch v0, :pswitch_data_0

    check-cast v3, Lone/me/startconversation/StartConversationScreen;

    iget-object v0, v3, Lone/me/startconversation/StartConversationScreen;->u0:Lbbd;
    ...
    invoke-virtual {v3}, Lone/me/qrscanner/QrScannerWidget;->A0()Ltrc;
    ...
    invoke-interface {v3, p0}, Lem6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v9, v3, Landroidx/fragment/app/c;->h:Lue0;
    ...
    :cond_6
    iget-object v6, v3, Landroidx/fragment/app/c;->h:Lue0;

    iget-object v6, v6, Lue0;->a:Ljava/util/ArrayList;
    ...
    iget-object v7, v7, Laj6;->b:Landroidx/fragment/app/a;
    ...
    iget-object v6, v2, Ltp4;->c:Ljava/util/ArrayList;
    ...
    :cond_9
    invoke-virtual {v2, v6}, Ltp4;->i(Ljava/util/List;)V

    invoke-virtual {v2, v6}, Ltp4;->c(Ljava/util/List;)V

    goto :goto_3

    :cond_a
    iget-object v1, v3, Landroidx/fragment/app/c;->h:Lue0;
    ...
    :cond_c
    iput-object v8, v3, Landroidx/fragment/app/c;->h:Lue0;
    ...
    :cond_10
    iget-object v0, v3, Landroidx/fragment/app/c;->g:Ljva;
    ...
    sget-object v0, Lone/me/calls/ui/ui/incoming/CallIncomingScreen;->s0:Lv1a;

    invoke-virtual {v3}, Lone/me/calls/ui/ui/incoming/CallIncomingScreen;->A0()Lmb1;

    move-result-object v0

    iget-object v0, v0, Lmb1;->s0:Ltcf;
    ...
    invoke-direct {v3, v2, v2}, Lib1;-><init>(ZZ)V
    ...
    iget-object v0, v3, Lc54;->router:Lytd;

    invoke-virtual {v0}, Lytd;->i()Lytd;

    move-result-object v0

    invoke-virtual {v0}, Lytd;->m()Z

    move-result v0

    if-nez v0, :cond_14

    invoke-virtual {p0, v2}, Lbva;->f(Z)V

    invoke-virtual {v3}, Lc54;->getOnBackPressedDispatcher()Ljva;

    move-result-object v0

    invoke-virtual {v0}, Ljva;->d()V

    iget-boolean v0, v3, Lc54;->isBeingDestroyed:Z

    if-nez v0, :cond_14

    invoke-virtual {p0, v1}, Lbva;->f(Z)V
...
.method public c(Lte0;)V
    ...
    :cond_0
    iget-object v2, v0, Landroidx/fragment/app/c;->h:Lue0;

    if-eqz v2, :cond_6

    new-instance v2, Ljava/util/ArrayList;

    iget-object v4, v0, Landroidx/fragment/app/c;->h:Lue0;
    ...
    :cond_2
    iget-object v5, v5, Ltp4;->c:Ljava/util/ArrayList;
    ...
    iget-object v7, v7, Lv7f;->k:Ljava/util/ArrayList;

    invoke-static {v6, v7}, Laf3;->v(Ljava/util/Collection;Ljava/lang/Iterable;)V

    goto :goto_0

    :cond_3
    invoke-static {v6}, Lue3;->h0(Ljava/lang/Iterable;)Ljava/util/Set;

    move-result-object v5

    invoke-static {v5}, Lue3;->d0(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {v8, p1}, Lu7f;->c(Lte0;)V
...
.method public d()V
    ...
    invoke-direct {v1, v0}, Lsi6;-><init>(Landroidx/fragment/app/c;)V

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroidx/fragment/app/c;->x(Lqi6;Z)V
