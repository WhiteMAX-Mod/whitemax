...
.method public constructor <init>(Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object p1, p0, Li3f;->a:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance p1, Lzl3;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Li3f;->b:Lzl3;
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lpy4;
    ...
    iget-object v2, p0, Li3f;->b:Lzl3;

    invoke-direct {v1, p1, v2}, Lnzd;-><init>(Ljava/lang/Runnable;Lqy4;)V

    iget-object p1, p0, Li3f;->b:Lzl3;
    ...
    :try_start_0
    iget-object p1, p0, Li3f;->a:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    :goto_0
    invoke-virtual {v1, p1}, Lnzd;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    :goto_1
    invoke-virtual {p0}, Li3f;->dispose()V
...
.method public final dispose()V
    ...
    iput-boolean v0, p0, Li3f;->c:Z

    iget-object v0, p0, Li3f;->b:Lzl3;
