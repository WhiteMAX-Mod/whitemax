...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lo45;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final f(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0}, Lo45;->getTopLevelDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget-object v0, Lcom/facebook/drawee/view/SimpleDraweeView;->v0:Lcf7;
    ...
    iput-object v0, p0, Lcom/facebook/drawee/view/SimpleDraweeView;->u0:Ly0;

    :goto_0
    if-eqz p2, :cond_4

    sget-object v0, Lw5d;->SimpleDraweeView:[I
    ...
    :try_start_1
    sget p2, Lw5d;->SimpleDraweeView_actualImageUri:I
    ...
    :cond_1
    sget p2, Lw5d;->SimpleDraweeView_actualImageResource:I
...
.method public final g(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lcom/facebook/drawee/view/SimpleDraweeView;->u0:Ly0;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    check-cast v0, Lc2c;

    invoke-virtual {v0, p1}, Lc2c;->c(Landroid/net/Uri;)V

    invoke-virtual {p0}, Lo45;->getController()Li45;

    move-result-object p1

    iput-object p1, v0, Ly0;->i:Li45;
...
.method public getControllerBuilder()Ly0;
    .locals 1
...
.method public setActualImageResource(I)V
    ...
    invoke-static {p1}, Lmwg;->c(I)Landroid/net/Uri;
...
.method public setImageRequest(Lrf7;)V
    .locals 1
...
.method public setImageResource(I)V
    ...
    invoke-super {p0, p1}, Lo45;->setImageResource(I)V
