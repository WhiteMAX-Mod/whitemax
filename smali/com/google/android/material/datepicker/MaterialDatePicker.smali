...
.method public static A0(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v1, v0}, Lwsi;->g(Landroid/content/Context;Ljava/lang/String;I)Landroid/util/TypedValue;
...
.method public static z0(Landroid/content/Context;)I
    ...
    invoke-static {v1}, Lvxg;->a(Ljava/util/Calendar;)Ljava/util/Calendar;
    ...
    sget v1, Ldwc;->mtrl_calendar_day_width:I

    invoke-virtual {p0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    sget v2, Ldwc;->mtrl_calendar_month_horizontal_padding:I
...
.method public final M(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->C1:Lmz0;
...
.method public final O(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget p3, Lk1d;->mtrl_picker_fullscreen:I

    goto :goto_0

    :cond_0
    sget p3, Lk1d;->mtrl_picker_dialog:I
    ...
    sget p3, Luxc;->mtrl_calendar_frame:I
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/MaterialDatePicker;->z0(Landroid/content/Context;)I
    ...
    :cond_1
    sget p3, Luxc;->mtrl_calendar_main_pane:I
    ...
    :goto_1
    sget p3, Luxc;->mtrl_picker_header_selection_text:I
    ...
    sget p3, Luxc;->mtrl_picker_header_toggle:I
    ...
    sget p3, Luxc;->mtrl_picker_title_text:I
    ...
    sget v3, Llxc;->material_ic_calendar_black_24dp:I

    invoke-static {p2, v3}, Leri;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    sget v4, Llxc;->material_ic_edit_black_24dp:I

    invoke-static {p2, v4}, Leri;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p2, p3}, Lhfh;->n(Landroid/view/View;Lz4;)V
    ...
    invoke-direct {v0, v1, p0}, Lye6;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p2, v0}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    sget p2, Luxc;->confirm_button:I
    ...
    invoke-virtual {p0}, Lcom/google/android/material/datepicker/MaterialDatePicker;->y0()V
...
.method public final b0(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->C1:Lmz0;
    ...
    iget-object v3, v2, Lmz0;->a:Lg2a;

    iget-wide v3, v3, Lg2a;->X:J

    iget-object v5, v2, Lmz0;->b:Lg2a;

    iget-wide v5, v5, Lg2a;->X:J

    iget-object v7, v2, Lmz0;->d:Lg2a;

    iget-wide v7, v7, Lg2a;->X:J

    invoke-static {v7, v8}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v7

    iput-object v7, v0, Llz0;->a:Ljava/lang/Long;

    iget v13, v2, Lmz0;->o:I

    iget-object v2, v2, Lmz0;->c:Luf4;
    ...
    :cond_0
    iget-object v7, v7, Lcom/google/android/material/datepicker/MaterialCalendar;->l1:Lg2a;
    ...
    invoke-static {v3, v4}, Lg2a;->c(J)Lg2a;

    move-result-object v9

    invoke-static {v5, v6}, Lg2a;->c(J)Lg2a;
    ...
    iget-object v0, v0, Llz0;->a:Ljava/lang/Long;
    ...
    invoke-static {v2, v3}, Lg2a;->c(J)Lg2a;
    ...
    :goto_1
    invoke-direct/range {v8 .. v13}, Lmz0;-><init>(Lg2a;Lg2a;Luf4;Lg2a;I)V
...
.method public final c0()V
    ...
    iget-object v1, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->S1:Lwq8;
    ...
    sget v2, Luxc;->fullscreen_header:I
    ...
    invoke-static {v2}, Lr9j;->b(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v9, v10, v8}, Leti;->d(IILandroid/content/Context;)I
    ...
    :cond_3
    invoke-static {v0, v6}, Ldsi;->d(Landroid/view/Window;Z)V
    ...
    invoke-static {v9, v10, v7}, Leti;->d(IILandroid/content/Context;)I

    move-result v7

    const/16 v9, 0x80

    invoke-static {v7, v9}, Lrf3;->i(II)I
    ...
    invoke-static {v2}, Leti;->g(I)Z

    move-result v2

    invoke-static {v6}, Leti;->g(I)Z
    ...
    invoke-static {v0}, Lw3i;->e(Landroid/view/Window;)Landroid/view/WindowInsetsController;

    move-result-object v11

    invoke-direct {v3, v11, v10}, Li4i;-><init>(Landroid/view/WindowInsetsController;Lvgd;)V

    iput-object v0, v3, Li4i;->c:Landroid/view/Window;
    ...
    invoke-direct {v3, v0, v10}, Lh4i;-><init>(Landroid/view/Window;Lvgd;)V

    :goto_6
    invoke-virtual {v3, v2}, Lhsi;->m(Z)V

    invoke-static {v8}, Leti;->g(I)Z

    move-result v2

    invoke-static {v7}, Leti;->g(I)Z
    ...
    invoke-direct {v3, v2}, Lvgd;-><init>(Landroid/view/View;)V
    ...
    invoke-direct {v2, v7, v3}, Li4i;-><init>(Landroid/view/WindowInsetsController;Lvgd;)V

    iput-object v0, v2, Li4i;->c:Landroid/view/Window;
    ...
    invoke-direct {v2, v0, v3}, Lh4i;-><init>(Landroid/view/Window;Lvgd;)V

    :goto_7
    invoke-virtual {v2, v6}, Lhsi;->l(Z)V
    ...
    invoke-direct {v3, v1, v2, v0, v6}, Lfua;-><init>(Ljava/lang/Object;III)V

    sget-object v0, Lhfh;->a:Ljava/util/WeakHashMap;

    invoke-static {v1, v3}, Lveh;->u(Landroid/view/View;Lzua;)V
    ...
    sget v6, Ldwc;->mtrl_calendar_dialog_background_inset:I
    ...
    iget-object v8, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->S1:Lwq8;
    ...
    invoke-direct {v6, v7, v3}, Lao7;-><init>(Landroid/app/Dialog;Landroid/graphics/Rect;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->C1:Lmz0;
...
.method public final v0()Landroid/app/Dialog;
    ...
    invoke-static {v1, v2}, Lcom/google/android/material/datepicker/MaterialDatePicker;->A0(Landroid/content/Context;I)Z
    ...
    sget v4, Ldvc;->materialCalendarStyle:I

    sget v5, Lm5d;->Widget_MaterialComponents_MaterialCalendar:I

    invoke-direct {v2, v1, v3, v4, v5}, Lwq8;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->S1:Lwq8;

    sget-object v2, Lz5d;->MaterialCalendar:[I
    ...
    sget v3, Lz5d;->MaterialCalendar_backgroundTint:I
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->S1:Lwq8;

    invoke-virtual {v2, v1}, Lwq8;->i(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, v2}, Lwq8;->k(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v2}, Lveh;->i(Landroid/view/View;)F

    move-result v2

    invoke-virtual {v1, v2}, Lwq8;->j(F)V
