...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj3f;->e:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v2, v3, v0, v1}, Lyvd;-><init>(Ljava/lang/String;IZ)V

    sput-object v2, Lj3f;->d:Lyvd;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lj3f;->c:Ljava/util/concurrent/atomic/AtomicReference;

    sget-boolean v1, Lp0e;->a:Z

    new-instance v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    const/4 v2, 0x1

    sget-object v3, Lj3f;->d:Lyvd;

    invoke-direct {v1, v2, v3}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sget-boolean v2, Lp0e;->a:Z
...
.method public final a()Lh0e;
    ...
    iget-object v1, p0, Lj3f;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Li3f;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lpy4;
    ...
    sget-object v7, Lcd5;->a:Lcd5;

    iget-object v6, p0, Lj3f;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v6, p1, v1}, Lko7;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Lko7;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
