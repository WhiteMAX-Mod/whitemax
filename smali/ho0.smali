...
# virtual methods
.method public final a(Ljkc;Lgo0;)V
    .locals 6

    iget-object v0, p0, Lho0;->a:Lti6;
    ...
    invoke-direct {v4, v0}, Lue0;-><init>(Landroidx/fragment/app/c;)V

    const/4 v5, 0x0

    invoke-virtual {v4, v5, v2, v1, v3}, Lue0;->f(ILandroidx/fragment/app/a;Ljava/lang/String;I)V

    invoke-virtual {v4, v3}, Lue0;->d(Z)I
    ...
    iput-object p1, v1, Landroidx/biometric/BiometricViewModel;->c:Ljkc;
    ...
    iput-object p1, v1, Landroidx/biometric/BiometricViewModel;->d:Lgo0;

    goto :goto_0

    :cond_4
    iput-object p2, v1, Landroidx/biometric/BiometricViewModel;->d:Lgo0;
    ...
    sget p2, Lc3d;->confirm_device_credential_password:I
    ...
    invoke-direct {p2, v0}, Lukd;-><init>(Landroid/content/Context;)V

    invoke-direct {p1, p2}, Ljdc;-><init>(Lukd;)V

    const/16 p2, 0xff

    invoke-virtual {p1, p2}, Ljdc;->e(I)I
    ...
    invoke-direct {p2, v2}, Lco0;-><init>(Landroidx/biometric/BiometricFragment;)V
