...
.method static constructor <clinit>()V
    ...
    sput-object v1, Liz7;->c:Ljava/util/Map;
    ...
    sput-object v0, Liz7;->d:Ljava/util/List;
...
.method public final a()[B
    ...
    iget-object v0, p0, Liz7;->b:Ljava/util/ArrayList;
    ...
    sget-object v6, Lkbg;->u0:Lkbg;

    iget-short v6, v6, Lkbg;->a:S
    ...
    iget-object v2, v1, Lhz7;->a:Lmbg;

    iget-short v2, v2, Lmbg;->a:S

    invoke-virtual {v5, v2}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget-object v2, v1, Lhz7;->a:Lmbg;

    sget-object v3, Liz7;->c:Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lhz7;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v2}, Liz7;->f(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v1}, Liz7;->f(Ljava/nio/ByteBuffer;[B)V

    goto :goto_1

    :cond_2
    sget-object v4, Lmbg;->o:Lmbg;
    ...
    invoke-static {v2}, Le5;->r(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v2

    invoke-static {v2}, Le5;->q(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v2}, Liz7;->e([B)V

    iget-object v1, v1, Lhz7;->a:Lmbg;
...
.method public final d(Ljava/nio/ByteBuffer;)I
    ...
    invoke-static {}, Lmbg;->values()[Lmbg;
    ...
    invoke-direct {v6, v2, v7}, Lfb3;-><init>(II)V
    ...
    sget-object v3, Liz7;->d:Ljava/util/List;
    ...
    invoke-static {v4}, Liz7;->c(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v4, v2, v3}, Lgz7;-><init>(Lmbg;Ljava/security/interfaces/ECPublicKey;)V
    ...
    :cond_1
    sget-object v3, Lmbg;->o:Lmbg;

    if-eq v2, v3, :cond_2

    sget-object v3, Lmbg;->X:Lmbg;
    ...
    invoke-static {v5}, Lilb;->e(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, Le5;->v()V

    invoke-static {v5, v4}, Le5;->s(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    invoke-direct {v4, v2, v3}, Lhz7;-><init>(Lmbg;Ljava/security/PublicKey;)V
