...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object v3, v1, Lold;->a:Lvgb;

    iget-object v1, v1, Lold;->b:Landroid/util/Size;

    invoke-virtual {v2, v3, v1}, Luld;->g(Lvgb;Landroid/util/Size;)V
    ...
    invoke-virtual {v2, v1}, Luld;->e(Ljava/lang/Object;)V
    ...
    iget-object v3, v1, Lnld;->a:Lvgb;

    iget-object v1, v1, Lnld;->b:Landroid/view/Surface;

    invoke-virtual {v2, v3, v1}, Luld;->f(Lvgb;Landroid/view/Surface;)V
    ...
    invoke-virtual {v2, v1}, Luld;->b(Ljava/lang/Object;)V
    ...
    iget-object v3, v1, Llld;->a:Lvgb;

    iget-object v4, v1, Llld;->b:Lxo8;

    iget-object v1, v1, Llld;->c:Landroid/os/Handler;

    invoke-virtual {v2, v3, v4, v1}, Luld;->a(Lvgb;Lxo8;Landroid/os/Handler;)V
    ...
    iget-object v3, v2, Lcjd;->h:Landroid/util/SparseArray;

    iget-object v4, v2, Lcjd;->i:Lhjd;

    iget-object v5, v4, Lhjd;->u0:Ljava/util/ArrayList;
    ...
    :pswitch_1
    iget-object v3, v4, Lhjd;->x0:Lcjd;
    ...
    :cond_8
    iget-object v2, v4, Lhjd;->z0:Lxu9;

    if-eqz v2, :cond_9

    instance-of v3, v12, La69;
    ...
    iget-object v2, v2, Lxu9;->b:Ljava/lang/Object;

    check-cast v2, Lf54;

    iget-object v2, v2, Lf54;->d:Ljava/lang/Object;

    check-cast v2, Lijd;

    check-cast v2, Lh69;

    iget-object v6, v2, Lh69;->s:La69;

    if-ne v6, v3, :cond_9

    invoke-virtual {v2}, Lh69;->c()Lk69;

    move-result-object v3

    const/4 v6, 0x2

    invoke-virtual {v2, v3, v6}, Lh69;->g(Lk69;I)V

    :cond_9
    invoke-virtual {v5, v12}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    invoke-interface {v12}, Ldjd;->c()V

    invoke-virtual {v4}, Lhjd;->o()V
    ...
    invoke-direct {v3, v1}, Lh59;-><init>(Landroid/os/Bundle;)V
    ...
    invoke-direct {v10, v9}, Lh59;-><init>(Landroid/os/Bundle;)V
    ...
    invoke-direct/range {v15 .. v20}, Ly59;-><init>(Lh59;IZZZ)V
    ...
    :cond_e
    iget-object v1, v4, Lhjd;->x0:Lcjd;
    ...
    :cond_11
    instance-of v1, v12, Lfjd;

    if-eqz v1, :cond_1d

    check-cast v12, Lfjd;

    invoke-virtual {v12, v3, v6}, Lz59;->l(Lh59;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v2, v9}, Lejd;->b(Landroid/os/Bundle;)V
    ...
    invoke-static {v2, v9}, Lejd;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {v9}, Lc69;->b(Landroid/os/Bundle;)Lc69;

    move-result-object v1

    invoke-virtual {v4, v2, v1}, Lhjd;->l(Lcjd;Lc69;)V
    ...
    invoke-static {v12, v9}, Lejd;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v3}, Ldjd;->b(Lcjd;)V
    ...
    :cond_19
    iget-object v1, v4, Lb69;->o:Lj59;

    if-eqz v1, :cond_1d

    iget-object v5, v4, Lhjd;->x0:Lcjd;
    ...
    iget-object v9, v1, Lj59;->a:Landroid/os/Bundle;
    ...
    invoke-static {v12, v12}, Lejd;->a(Ljava/lang/String;Landroid/os/Bundle;)V
