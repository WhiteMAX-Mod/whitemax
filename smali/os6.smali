...
.method static constructor <clinit>()V
    ...
    sput-object v0, Los6;->a:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Los6;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)I
    ...
    sget v1, Lnuc;->common_google_play_services_unknown_issue:I
    ...
    sget-object v0, Los6;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    sget-object v0, Lnci;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_1
    sget-boolean v2, Lnci;->b:Z
    ...
    :cond_1
    sput-boolean v1, Lnci;->b:Z

    invoke-virtual {p0}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Lbqh;->a(Landroid/content/Context;)Lt64;
    ...
    invoke-static {v1, p1, v2, v0, v3}, Ley1;->h(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    :goto_4
    invoke-static {p0}, Lxyi;->a(Landroid/content/Context;)Z
    ...
    sget-object v0, Lxyi;->c:Ljava/lang/Boolean;
    ...
    sput-object v0, Lxyi;->c:Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lrs6;->u(Landroid/content/Context;)Lrs6;

    invoke-static {v7, v1}, Lrs6;->P(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v6, v1}, Lrs6;->P(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p1, v0, v3, v1, v2}, Laab;->l(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
