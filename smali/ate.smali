...
.method public final a(Landroid/graphics/Matrix;Lvse;ILandroid/graphics/Canvas;)V
    ...
    iget v10, v4, Lcte;->d:F

    iget v4, v4, Lcte;->e:F

    invoke-direct {v7, v8, v9, v10, v4}, Landroid/graphics/RectF;-><init>(FFFF)V

    iget-object v8, v0, Lvse;->b:Landroid/graphics/Paint;
    ...
    :goto_0
    iget-object v12, v0, Lvse;->g:Landroid/graphics/Path;

    const/4 v13, 0x3

    const/4 v14, 0x2

    sget-object v19, Lvse;->k:[I

    if-eqz v9, :cond_1

    aput v11, v19, v11

    iget v11, v0, Lvse;->f:I

    aput v11, v19, v10

    iget v11, v0, Lvse;->e:I

    aput v11, v19, v14

    iget v11, v0, Lvse;->d:I
    ...
    iget-object v0, v0, Lvse;->h:Landroid/graphics/Paint;
