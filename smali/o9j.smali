...
# direct methods
.method public static final a(Lu6e;Lr03;)Z
    .locals 4
    ...
    iget-object p1, p1, Lp03;->a:Ljava/util/Set;

    iget-object p0, p0, Lu6e;->d:Lpb2;

    if-eqz p0, :cond_1

    iget-wide v2, p0, Lpb2;->a:J
    ...
    :goto_0
    invoke-static {p1, p0}, Lue3;->A(Ljava/lang/Iterable;Ljava/lang/Object;)Z
...
.method public static b(Ltm9;)Ld35;
    .locals 17
    ...
    invoke-static {v1, v13, v14}, Lefi;->l(Ltm9;J)J
    ...
    invoke-static {v1}, Lt9j;->d(Ltm9;)Lkfe;
    ...
    invoke-direct {v13, v11, v12}, Limb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :cond_15
    invoke-static {v10}, Lto8;->r(Ljava/util/ArrayList;)Ljava/util/Map;
    ...
    invoke-direct {v0, v9, v10}, Ld35;-><init>(Ljava/util/Map;Ljava/util/Map;)V
