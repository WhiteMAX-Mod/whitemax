...
# static fields
.field public static final d:Lvm3;

.field public static final e:Lyvd;

.field public static final f:I

.field public static final g:Lwm3;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3}, Lyvd;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Leha;-><init>(Ljava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lxm3;->g:Lwm3;
    ...
    invoke-direct {v3, v4, v0, v1}, Lyvd;-><init>(Ljava/lang/String;IZ)V

    sput-object v3, Lxm3;->e:Lyvd;

    new-instance v0, Lvm3;

    invoke-direct {v0, v2, v3}, Lvm3;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lxm3;->d:Lvm3;

    iget-object v0, v0, Lvm3;->b:[Lwm3;
    ...
    invoke-virtual {v3}, Leha;->dispose()V
...
.method public constructor <init>()V
    ...
    sget-object v1, Lxm3;->d:Lvm3;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lxm3;->c:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v2, Lvm3;

    sget v3, Lxm3;->f:I

    sget-object v4, Lxm3;->e:Lyvd;

    invoke-direct {v2, v3, v4}, Lvm3;-><init>(ILjava/util/concurrent/ThreadFactory;)V
...
.method public final a()Lh0e;
    ...
    iget-object v1, p0, Lxm3;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v1}, Lvm3;->a()Lwm3;

    move-result-object v1

    invoke-direct {v0, v1}, Lum3;-><init>(Lwm3;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lpy4;
    ...
    iget-object v0, p0, Lxm3;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lpy4;
    ...
    iget-object v1, v0, Leha;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    new-instance p4, Lko7;

    invoke-direct {p4, p1, v1}, Lko7;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p4, p1}, Lko7;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
