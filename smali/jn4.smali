...
.field public final Z:Lh79;

.field public final o:I

.field public final s0:Lh79;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;IILh79;)V
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, v0}, Lmj0;-><init>(Z)V

    iput-object p1, p0, Ljn4;->Y:Ljava/lang/String;

    iput p2, p0, Ljn4;->o:I

    iput p3, p0, Ljn4;->X:I

    iput-object p4, p0, Ljn4;->Z:Lh79;
    ...
    iput-object p1, p0, Ljn4;->s0:Lh79;
...
.method public final H(Lze4;)J
    ...
    iput-object v0, v1, Ljn4;->t0:Lze4;

    const-wide/16 v12, 0x0

    iput-wide v12, v1, Ljn4;->z0:J

    iput-wide v12, v1, Ljn4;->y0:J

    invoke-virtual/range {p0 .. p1}, Lmj0;->d(Lze4;)V
    ...
    iget-object v3, v0, Lze4;->a:Landroid/net/Uri;
    ...
    iget-object v4, v0, Lze4;->d:[B

    iget-wide v5, v0, Lze4;->f:J

    iget-wide v7, v0, Lze4;->g:J
    ...
    :goto_0
    iget-object v11, v0, Lze4;->e:Ljava/util/Map;

    const/4 v10, 0x1

    invoke-virtual/range {v1 .. v11}, Ljn4;->g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v2

    iget-wide v3, v0, Lze4;->f:J

    iget-wide v5, v0, Lze4;->g:J

    iput-object v2, v1, Ljn4;->u0:Ljava/net/HttpURLConnection;

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v7

    iput v7, v1, Ljn4;->x0:I
    ...
    sget-object v8, Lma7;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v9}, La8i;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v9, Lma7;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v5}, La8i;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v10, v5}, La8i;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v2, v1, Ljn4;->v0:Ljava/io/InputStream;

    if-eqz v7, :cond_a

    new-instance v2, Ljava/util/zip/GZIPInputStream;

    iget-object v6, v1, Ljn4;->v0:Ljava/io/InputStream;
    ...
    :goto_6
    iput-boolean v9, v1, Ljn4;->w0:Z

    invoke-virtual/range {p0 .. p1}, Lmj0;->e(Lze4;)V

    :try_start_5
    invoke-virtual {v1, v3, v4}, Ljn4;->h(J)V
    :try_end_5
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_4

    iget-wide v2, v1, Ljn4;->y0:J
    ...
    :cond_c
    sget-object v8, Lma7;->b:Ljava/util/regex/Pattern;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Ljn4;->v0:Ljava/io/InputStream;
    :try_end_0
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, Ljn4;->v0:Ljava/io/InputStream;

    invoke-virtual {p0}, Ljn4;->f()V

    iget-boolean v2, p0, Ljn4;->w0:Z

    if-eqz v2, :cond_1

    iput-boolean v0, p0, Ljn4;->w0:Z

    invoke-virtual {p0}, Lmj0;->c()V

    :cond_1
    iput-object v1, p0, Ljn4;->u0:Ljava/net/HttpURLConnection;

    iput-object v1, p0, Ljn4;->t0:Lze4;
...
.method public final f()V
    ...
    iget-object v0, p0, Ljn4;->u0:Ljava/net/HttpURLConnection;
...
.method public final g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Ljn4;->Z:Lh79;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lh79;->A()Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, p0, Ljn4;->s0:Lh79;
    ...
    :cond_1
    sget-object p10, Lma7;->a:Ljava/util/regex/Pattern;
    ...
    :cond_4
    iget-object p4, p0, Ljn4;->Y:Ljava/lang/String;
    ...
    invoke-static {p2}, Lze4;->b(I)Ljava/lang/String;
...
.method public final getUri()Landroid/net/Uri;
    ...
    :cond_0
    iget-object v0, p0, Ljn4;->t0:Lze4;
...
.method public final h(J)V
    ...
    iget-object v5, p0, Ljn4;->v0:Ljava/io/InputStream;
    ...
    invoke-virtual {p0, v4}, Lmj0;->b(I)V
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Ljn4;->v0:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Ljn4;->z0:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Ljn4;->z0:J
