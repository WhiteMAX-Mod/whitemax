...
.method public synthetic constructor <init>(Ljava/lang/Object;III)V
    ...
    iput-object p1, p0, Lvu0;->d:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object v0, p0, Lvu0;->d:Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, v2}, Ls4h;->l(II)V
    ...
    invoke-virtual {v0, v1, v2}, Lmj6;->a(II)V
    ...
    iget-boolean v3, v0, Lmj6;->s0:Z

    if-eqz v3, :cond_4

    iget-boolean v3, v0, Lmj6;->t0:Z

    if-eqz v3, :cond_4

    iget-object v3, v0, Lmj6;->X:Lorg/webrtc/ScreenCapturerAndroid;
    ...
    invoke-interface {v0, v1, v3, v2}, Ly6d;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_5
    iget-object v5, v0, Lxu0;->i:Ll16;

    iget v6, v0, Lxu0;->e:I

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v4, v6}, Ln7j;->h(II)Lto7;
    ...
    invoke-virtual {v8}, Lso7;->nextInt()I

    move-result v8

    add-int/2addr v8, v3

    invoke-virtual {v5, v8}, Ll16;->d(I)I
    ...
    iget-object v8, v0, Lxu0;->l:Ljava/util/Set;
    ...
    iget-object v7, v0, Lxu0;->f:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v7}, Ljava/util/concurrent/ConcurrentHashMap;->keySet()Ljava/util/Set;

    move-result-object v7

    invoke-static {v7, v5}, Lgke;->e(Ljava/util/Set;Ljava/util/Set;)Ljava/util/Set;
    ...
    iget-object v10, v0, Lxu0;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v12, v10, Lwu0;->a:Lqk4;

    invoke-virtual {v12}, Lvc3;->w()Lvc3;
    ...
    iget-object v12, v0, Lxu0;->a:Lr2c;

    invoke-virtual {v12}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v13, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-virtual {v12, v1, v2, v13}, Lr2c;->c(IILandroid/graphics/Bitmap$Config;)Lvc3;
    ...
    invoke-direct {v10, v13}, Lwu0;-><init>(Lqk4;)V

    invoke-virtual {v12}, Lvc3;->l()Lvc3;

    move-result-object v12

    :goto_8
    iput-boolean v9, v10, Lwu0;->b:Z

    :try_start_1
    invoke-virtual {v0, v8, v12}, Lxu0;->f(ILvc3;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    invoke-interface {v12}, Ljava/io/Closeable;->close()V

    iget-object v9, v0, Lxu0;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v12, v0}, Lr4j;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, v4, v1}, Ln7j;->c(III)I
