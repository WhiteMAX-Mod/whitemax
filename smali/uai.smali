...
.method public abstract U(Landroid/os/Parcel;I)Z
.end method
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Luai;->V(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Luai;->T(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_5
    invoke-virtual {p0, p2, p1}, Luai;->U(Landroid/os/Parcel;I)Z
    ...
    iget-object p1, p3, Lrpi;->f:Lsri;

    iget-object p1, p1, Lsri;->a:Lz8j;

    if-eqz p1, :cond_b

    iget-object p2, p3, Lrpi;->e:Ln2g;

    iget-object p4, p1, Lz8j;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Lz8j;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, v3, p1}, La2j;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Lz8j;->a()Landroid/os/Handler;
    ...
    :cond_b
    :goto_7
    iget-object p1, p3, Lrpi;->d:Lhx5;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Lhx5;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p4, p1, p2}, Lkci;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Lrpi;->e:Ln2g;

    invoke-virtual {p1, p4}, Ln2g;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p3, Lq5j;->f:Lp6j;

    iget-object p1, p1, Lp6j;->a:Ljcj;

    iget-object p2, p3, Lq5j;->e:Ln2g;

    invoke-virtual {p1, p2}, Ljcj;->c(Ln2g;)V

    iget-object p1, p3, Lq5j;->d:Lulc;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Lulc;->v(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p4, v2}, Lulc;->v(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Ln2g;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_9

    :cond_15
    iget-object p1, p3, Lq5j;->g:Lp6j;
    ...
    iget-object p1, p1, Lp6j;->d:Lx8j;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Lx8j;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Lx8j;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Lrq;-><init>(I)V

    invoke-virtual {p2, p1}, Ln2g;->d(Ljava/lang/Object;)V
    ...
    :cond_1d
    invoke-virtual {p0, p1, p2, p3}, Luai;->S(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
