...
.method static constructor <clinit>()V
    ...
    sput-object v0, Laxf;->o:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lc5i;)V
    .locals 2
    ...
    invoke-direct {v1, p1}, Lzwf;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Laxf;->a:Landroid/content/Context;

    iput-object p2, p0, Laxf;->c:Lc5i;

    iput-object v0, p0, Laxf;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Laxf;->d:Lzwf;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Laxf;->o:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Lcei;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    sget-object v2, Laxf;->o:Ljava/lang/String;

    const-string v3, "getAllPendingJobs() is not reliable on this device."

    invoke-virtual {v1, v2, v3, p1}, Lcei;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Lv4i;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Lv4i;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Laxf;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Laxf;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Laxf;->f(Landroid/app/job/JobInfo;)Lv4i;
    ...
    invoke-static {v1, v2}, Laxf;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object v0, p0, Laxf;->c:Lc5i;

    iget-object v0, v0, Lc5i;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->u()Lywf;
    ...
    iget-object v0, v0, Lywf;->d:Ljava/lang/Object;
...
.method public final varargs e([Lr5i;)V
    ...
    invoke-direct {v2, v1}, Lqc7;-><init>(Landroidx/work/impl/WorkDatabase;)V
    ...
    iget-object v7, v5, Lr5i;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Ls5i;->p(Ljava/lang/String;)Lr5i;
    ...
    sget-object v9, Laxf;->o:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Lcei;->o(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v5}, Lnsi;->d(Lr5i;)Lv4i;

    move-result-object v6

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->u()Lywf;

    move-result-object v7

    invoke-virtual {v7, v6}, Lywf;->o(Lv4i;)Lxwf;
    ...
    iget-object v9, v2, Lqc7;->a:Landroidx/work/impl/WorkDatabase;

    new-instance v10, Lpc7;

    invoke-direct {v10, v2, v8}, Lpc7;-><init>(Lqc7;I)V

    invoke-virtual {v9, v10}, Llrd;->o(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Lv4i;->a:Ljava/lang/String;

    iget v6, v6, Lv4i;->b:I

    invoke-direct {v7, v9, v6, v8}, Lxwf;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lc5i;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->u()Lywf;

    move-result-object v6

    invoke-virtual {v6, v7}, Lywf;->p(Lxwf;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Laxf;->g(Lr5i;I)V
...
.method public final g(Lr5i;I)V
    .locals 18
    ...
    iget-object v3, v1, Laxf;->b:Landroid/app/job/JobScheduler;

    iget-object v4, v1, Laxf;->d:Lzwf;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v5, v2, Lr5i;->j:Lbu3;

    new-instance v6, Landroid/os/PersistableBundle;

    invoke-direct {v6}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v7, v2, Lr5i;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v6}, Li7c;->p(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)V
    ...
    sget-object v14, Lzwf;->b:Ljava/lang/String;

    invoke-static {v6}, Lvb9;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {v11, v14, v6}, Lcei;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, v2, Lr5i;->l:Leg0;

    sget-object v8, Leg0;->b:Leg0;
    ...
    :cond_7
    iget-boolean v10, v2, Lr5i;->q:Z

    if-nez v10, :cond_8

    invoke-static {v4}, Li7c;->o(Landroid/app/job/JobInfo$Builder;)V
    ...
    iget-boolean v11, v10, Lau3;->b:Z

    new-instance v6, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v10, v10, Lau3;->a:Landroid/net/Uri;
    ...
    invoke-static {v4}, Lz19;->o(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v5, v9, v8}, Lcei;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v9, v5}, Lcei;->o(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v4, v2, Lr5i;->q:Z

    if-eqz v4, :cond_e

    iget-object v4, v2, Lr5i;->r:Lujb;
    ...
    invoke-virtual {v5, v9, v4}, Lcei;->c(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual/range {p0 .. p2}, Laxf;->g(Lr5i;I)V
    :try_end_1
    ...
    invoke-virtual {v3, v9, v2, v0}, Lcei;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object v2, v1, Laxf;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Laxf;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    iget-object v4, v1, Laxf;->c:Lc5i;

    iget-object v5, v4, Lc5i;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->x()Ls5i;

    move-result-object v5

    invoke-virtual {v5}, Ls5i;->m()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9, v2}, Lcei;->e(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Ljava/lang/IllegalStateException;

    invoke-direct {v3, v2, v0}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v0, v4, Lc5i;->b:Lqo3;
