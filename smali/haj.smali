...
# direct methods
.method public static a(Landroid/net/Uri;Landroid/content/Context;Lqx5;)Landroid/net/Uri;
    .locals 7
    ...
    invoke-virtual {p2, v3}, Liz5;->p(Ljava/lang/String;)Ljava/io/File;
    ...
    :try_start_2
    invoke-static {v4, v3}, Lgbj;->f(Ljava/io/InputStream;Ljava/io/OutputStream;)J
...
.method public static c(Landroid/content/Intent;)I
    ...
    invoke-static {v0, v3, v1}, Ldnf;->r(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v0, p0, v1}, Lvmf;->s(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
...
.method public static d(Landroid/content/Intent;Landroid/content/Context;Lyi5;Lqx5;)Ljava/util/ArrayList;
    .locals 3
    ...
    invoke-static {v1, p1, p2}, Lxpi;->n(Landroid/net/Uri;Landroid/content/Context;Lyi5;)Z
    ...
    invoke-static {v1, p1, p3}, Lhaj;->a(Landroid/net/Uri;Landroid/content/Context;Lqx5;)Landroid/net/Uri;
...
.method public static e(Landroid/content/Intent;Landroid/content/Context;Lyi5;Lqx5;)Ljava/util/ArrayList;
    .locals 3
    ...
    :cond_3
    invoke-static {p0, p1, p2}, Lxpi;->n(Landroid/net/Uri;Landroid/content/Context;Lyi5;)Z
    ...
    invoke-static {p0, p1, p3}, Lhaj;->a(Landroid/net/Uri;Landroid/content/Context;Lqx5;)Landroid/net/Uri;
