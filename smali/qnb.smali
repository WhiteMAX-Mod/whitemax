...
# direct methods
.method public synthetic constructor <init>(Lz26;Ldob;I)V
    .locals 0

    iput p3, p0, Lqnb;->a:I

    iput-object p1, p0, Lqnb;->b:Lz26;

    iput-object p2, p0, Lqnb;->c:Ldob;
...
.method public final a(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Lvnb;-><init>(Lqnb;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p2, v0, Lvnb;->d:Ljava/lang/Object;
    ...
    iget-object v3, v3, Lonb;->c:Ljava/util/Map;
    ...
    iget-wide v5, v5, Lzi1;->a:J

    invoke-virtual {v2, v5, v6}, Ln8a;->d(J)Z
    ...
    invoke-direct {v5, p0, p2}, Lsnb;-><init>(Lqnb;Lkotlin/coroutines/Continuation;)V

    :goto_3
    iget-object p2, v5, Lsnb;->d:Ljava/lang/Object;
    ...
    iget-object v6, p0, Lqnb;->c:Ldob;

    sget-object v7, Ldob;->A0:[Lyy7;

    iget-object v7, v6, Ldob;->a:Lsv1;

    iget-object v8, v6, Ldob;->s0:Lbwf;
    ...
    invoke-direct {v9, v6, p1, v2, v1}, Lcob;-><init>(Ldob;Ljava/util/List;Lbj1;Lkotlin/coroutines/Continuation;)V

    const/4 p1, 0x2

    invoke-static {v7, v8, v1, v9, p1}, Lsvi;->e(Lf84;Lx74;Li84;Lsm6;I)Lx9f;

    iput v4, v5, Lsnb;->o:I

    invoke-interface {p2, v0, v5}, Lz26;->a(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Lpnb;-><init>(Lqnb;Lkotlin/coroutines/Continuation;)V

    :goto_5
    iget-object p2, v0, Lpnb;->d:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v5, v7, v6, v1}, Ll6b;->c(Llg8;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v2, p0, Lqnb;->c:Ldob;

    iget-object v2, v2, Ldob;->c:Ltf1;

    invoke-virtual {v2, p1, v1, v4, v4}, Ltf1;->a(Lru/ok/android/externcalls/sdk/Conversation;Lru/ok/android/externcalls/sdk/ConversationParticipant;ZZ)Laj1;

    move-result-object v2

    iget-object v5, p0, Lqnb;->c:Ldob;

    iget-object v5, v5, Ldob;->z0:Ltcf;
    ...
    invoke-static {v8}, Lknb;->a(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lzi1;
    ...
    :cond_12
    iget-object v8, v8, Lcnb;->a:Lbj1;

    invoke-interface {v8}, Lbj1;->n()Z

    move-result v8

    :goto_9
    iget-object v9, p0, Lqnb;->c:Ldob;

    iget-object v9, v9, Ldob;->c:Ltf1;

    const/4 v10, 0x0

    invoke-virtual {v9, p1, v7, v10, v8}, Ltf1;->a(Lru/ok/android/externcalls/sdk/Conversation;Lru/ok/android/externcalls/sdk/ConversationParticipant;ZZ)Laj1;
    ...
    invoke-direct {v2, p1, v1}, Limb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
