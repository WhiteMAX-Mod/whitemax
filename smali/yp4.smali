...
.method public constructor <init>(Lu75;)V
    ...
    iput-object v0, p0, Lyp4;->o:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lyp4;->X:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lyp4;->Y:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lyp4;->Z:Ljava/util/LinkedHashMap;

    iput v1, p0, Lyp4;->s0:I

    iput-boolean v1, p0, Lyp4;->t0:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lyp4;->u0:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lyp4;->b:Landroid/os/HandlerThread;
    ...
    invoke-direct {v0, v1}, La07;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lyp4;->c:La07;

    new-instance v0, Ltz4;

    invoke-direct {v0}, Ltz4;-><init>()V

    iput-object v0, p0, Lyp4;->a:Ltz4;

    :try_start_0
    new-instance v0, Li00;

    invoke-direct {v0, p0, p1}, Li00;-><init>(Lyp4;Lu75;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Lwu1;->get()Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {p0}, Lyp4;->release()V
...
.method public final a()V
    ...
    iget-boolean v0, p0, Lyp4;->t0:Z

    if-eqz v0, :cond_2

    iget v0, p0, Lyp4;->s0:I

    if-nez v0, :cond_2

    iget-object v0, p0, Lyp4;->Z:Ljava/util/LinkedHashMap;
    ...
    :cond_0
    iget-object v1, p0, Lyp4;->u0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Ltu1;->d(Ljava/lang/Throwable;)Z
    ...
    iget-object v0, p0, Lyp4;->a:Ltz4;

    invoke-virtual {v0}, Ltz4;->q()V

    iget-object v0, p0, Lyp4;->b:Landroid/os/HandlerThread;
...
.method public final b(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    ...
    :try_start_0
    iget-object v0, p0, Lyp4;->c:La07;

    new-instance v1, Lcj;

    const/16 v2, 0x14

    invoke-direct {v1, p0, p2, p1, v2}, Lcj;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final c(Ljava/lang/Exception;)V
    ...
    iget-object v0, p0, Lyp4;->u0:Ljava/util/ArrayList;
...
.method public final d(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Lfui;->c([FF)V

    invoke-static {v1}, Lfui;->d([F)V
    ...
    invoke-static {v6}, Lho6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Lho6;->b(Ljava/lang/String;)V
    ...
    invoke-static/range {v16 .. v16}, Lho6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Lho6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lho6;->b(Ljava/lang/String;)V
    ...
    iput-object v6, v3, Ltz4;->k:Ljava/lang/Object;
    ...
    iget-object v6, v3, Ltz4;->m:Ljava/lang/Object;

    check-cast v6, Lfo6;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v10, v6, Lgo6;
    ...
    invoke-static {v4}, Lho6;->b(Ljava/lang/String;)V
...
.method public final e(Lcjg;)V
    ...
    invoke-virtual {p0, p1}, Lyp4;->c(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Lcjg;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Lcjg;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lyp4;->d(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Lcjg;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Lu90;->c:Ltu1;

    invoke-virtual {v8, v3}, Ltu1;->b(Ljava/lang/Object;)Z
...
.method public final f(Lmsf;)V
    .locals 3

    iget-object v0, p0, Lyp4;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p1, v2}, Lwp4;-><init>(Lmsf;I)V

    invoke-virtual {p0, v0, v1}, Lyp4;->b(Ljava/lang/Runnable;Ljava/lang/Runnable;)V

    return-void
.end method

.method public final h(II)Lha8;
    .locals 1

    new-instance v0, Laj4;

    invoke-direct {v0, p0, p1, p2}, Laj4;-><init>(Ljava/lang/Object;II)V
...
.method public final j(Lfsf;)V
    ...
    invoke-virtual {p1}, Lfsf;->close()V
    ...
    invoke-direct {v1, v2, p1}, Lqj4;-><init>(ILjava/lang/Object;)V
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lyp4;->X:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lyp4;->Z:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lyp4;->Y:[F

    invoke-virtual {v3, v5, v0}, Lfsf;->w([F[F)V
    ...
    :try_start_0
    iget-object v3, p0, Lyp4;->a:Ltz4;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Ltz4;->t(J[FLandroid/view/Surface;)V
    :try_end_0
    ...
    invoke-static {v6, v7}, Lz5j;->f(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v8}, Lz5j;->f(Ljava/lang/String;Z)V

    new-instance v2, Lcjg;

    iget-object v3, v3, Lfsf;->d:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Lcjg;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lyp4;->e(Lcjg;)V
    :try_end_1
...
.method public final release()V
    ...
    invoke-direct {v0, v1, p0}, Lqj4;-><init>(ILjava/lang/Object;)V
