...
.field public final s0:Ljxf;

.field public final t0:Ljava/lang/Object;

.field public final u0:Ljava/lang/Object;

.field public final v0:Lo69;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lixf;->C0:Ljava/util/ArrayList;
    ...
    sput-object v1, Lixf;->D0:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Lh69;)V
    ...
    invoke-direct {v0, v2, v1}, La3b;-><init>(ILjava/lang/Object;)V
    ...
    iput-object v0, p0, Lixf;->A0:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lixf;->B0:Ljava/util/ArrayList;

    iput-object p2, p0, Lixf;->s0:Ljxf;
    ...
    iput-object p2, p0, Lixf;->t0:Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lq69;-><init>(Lixf;)V

    iput-object v1, p0, Lixf;->u0:Ljava/lang/Object;

    new-instance v0, Lo69;

    invoke-direct {v0, p0}, Lo69;-><init>(Ln69;)V

    iput-object v0, p0, Lixf;->v0:Lo69;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget v0, Lj4d;->mr_user_route_category_name:I
    ...
    iput-object p1, p0, Lixf;->w0:Landroid/media/MediaRouter$RouteCategory;

    invoke-virtual {p0}, Lixf;->v()V

    return-void
.end method

.method public static n(Ljava/lang/Object;)Lhxf;
    .locals 1
...
.method public final a(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-static {p1}, Lixf;->n(Ljava/lang/Object;)Lhxf;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-object p1, p1, Lhxf;->a:Lk69;

    invoke-virtual {p1, p2}, Lk69;->j(I)V
...
.method public final b(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual {p1, p2}, Lk69;->k(I)V
...
.method public final d(Ljava/lang/String;)La69;
    ...
    invoke-virtual {p0, p1}, Lixf;->k(Ljava/lang/String;)I

    move-result p1

    if-ltz p1, :cond_0

    iget-object v0, p0, Lixf;->A0:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lgxf;->a:Ljava/lang/Object;

    invoke-direct {v0, p1}, Lfxf;-><init>(Ljava/lang/Object;)V
...
.method public final f(Lj59;)V
    ...
    iget-object v1, p1, Lj59;->b:Ld69;

    invoke-virtual {v1}, Ld69;->b()Ljava/util/ArrayList;
    ...
    :goto_2
    iget v1, p0, Lixf;->x0:I

    if-ne v1, v0, :cond_5

    iget-boolean v1, p0, Lixf;->y0:Z
    ...
    :cond_5
    :goto_3
    iput v0, p0, Lixf;->x0:I

    iput-boolean p1, p0, Lixf;->y0:Z
...
.method public final i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lixf;->j(Ljava/lang/Object;)I

    move-result v0

    if-gez v0, :cond_5

    invoke-virtual {p0}, Lixf;->m()Landroid/media/MediaRouter$RouteInfo;

    move-result-object v0

    const-string v1, ""

    iget-object v2, p0, Lb69;->a:Landroid/content/Context;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lixf;->k(Ljava/lang/String;)I
    ...
    invoke-static {v3, v0, v4}, Lxc0;->e(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0, v4}, Lixf;->k(Ljava/lang/String;)I
    ...
    invoke-direct {v3, p1, v0}, Lgxf;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-direct {v4, v0, v1}, Lhc8;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v3, v4}, Lixf;->o(Lgxf;Lhc8;)V

    invoke-virtual {v4}, Lhc8;->v()Lh59;

    move-result-object p1

    iput-object p1, v3, Lgxf;->c:Lh59;

    iget-object p1, p0, Lixf;->A0:Ljava/util/ArrayList;
...
.method public final j(Ljava/lang/Object;)I
    ...
    iget-object v3, v3, Lgxf;->a:Ljava/lang/Object;
...
.method public final l(Lk69;)I
    .locals 4

    iget-object v0, p0, Lixf;->B0:Ljava/util/ArrayList;
...
.method public o(Lgxf;Lhc8;)V
    .locals 3

    iget-object v0, p2, Lhc8;->b:Ljava/lang/Object;
    ...
    sget-object v2, Lixf;->C0:Ljava/util/ArrayList;

    invoke-virtual {p2, v2}, Lhc8;->q(Ljava/util/List;)V
    ...
    sget-object v1, Lixf;->D0:Ljava/util/ArrayList;

    invoke-virtual {p2, v1}, Lhc8;->q(Ljava/util/List;)V
...
.method public final p(Lk69;)V
    ...
    iget-object v1, p0, Lixf;->t0:Ljava/lang/Object;

    if-eq v0, p0, :cond_0

    check-cast v1, Landroid/media/MediaRouter;

    iget-object v0, p0, Lixf;->w0:Landroid/media/MediaRouter$RouteCategory;
    ...
    invoke-direct {v2, p1, v0}, Lhxf;-><init>(Lk69;Landroid/media/MediaRouter$UserRouteInfo;)V

    invoke-virtual {v0, v2}, Landroid/media/MediaRouter$RouteInfo;->setTag(Ljava/lang/Object;)V

    iget-object p1, p0, Lixf;->v0:Lo69;
    ...
    invoke-virtual {p0, v2}, Lixf;->w(Lhxf;)V

    iget-object p1, p0, Lixf;->B0:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lixf;->j(Ljava/lang/Object;)I

    move-result v0

    if-ltz v0, :cond_1

    iget-object v1, p0, Lixf;->A0:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Lk69;->l()V

    :cond_1
    return-void
.end method

.method public final q(Lk69;)V
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lixf;->l(Lk69;)I
    ...
    iget-object p1, p1, Lhxf;->b:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lixf;->t0:Ljava/lang/Object;
...
.method public final r(Lk69;)V
    .locals 1

    invoke-virtual {p1}, Lk69;->g()Z
    ...
    invoke-virtual {p0, p1}, Lixf;->t(Ljava/lang/Object;)V
...
.method public final s()V
    ...
    invoke-direct {v0, v2, v3}, Lc69;-><init>(Ljava/util/ArrayList;Z)V
...
.method public final v()V
    ...
    invoke-virtual {p0, v1}, Lixf;->i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lixf;->s()V

    :cond_2
    return-void
.end method

.method public w(Lhxf;)V
    .locals 3

    iget-object v0, p1, Lhxf;->b:Ljava/lang/Object;

    iget-object v1, p1, Lhxf;->a:Lk69;

    iget-object v2, v1, Lk69;->d:Ljava/lang/String;
