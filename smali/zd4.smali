...
.method public final a(Lysc;Lbtc;Lbj;)V
    ...
    :try_start_0
    iget-wide v0, p0, Lzd4;->b:J

    iget-wide v2, p2, Lb36;->e:J

    cmp-long p1, v0, v2

    if-lez p1, :cond_1

    iget-wide v4, p2, Lb36;->f:J
    ...
    :goto_0
    iput-wide v0, p2, Lb36;->e:J

    if-eqz p1, :cond_1

    iget-object p1, p2, Lb36;->j:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p3, Lov3;

    const/4 v0, 0x1

    invoke-direct {p3, v0, p2}, Lov3;-><init>(ILjava/lang/Object;)V
