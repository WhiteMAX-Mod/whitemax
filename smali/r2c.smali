...
.method public static a(II)V
    ...
    invoke-static {v2, p0}, Ll5j;->b(Ljava/lang/String;Z)V
    ...
    invoke-static {p0, v0}, Ll5j;->b(Ljava/lang/String;Z)V
...
# virtual methods
.method public final b(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;)Lqk4;
    .locals 9

    const-string v0, "Source bitmap cannot be null"

    invoke-static {p1, v0}, Ll5j;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v3, v2}, Ll5j;->b(Ljava/lang/String;Z)V
    ...
    invoke-static {p4, p5}, Lr2c;->a(II)V
    ...
    invoke-static {v4, v3}, Ll5j;->b(Ljava/lang/String;Z)V
    ...
    invoke-static {v5, v4}, Ll5j;->b(Ljava/lang/String;Z)V
    ...
    :goto_7
    invoke-static {v6, v7}, Lr2c;->a(II)V

    invoke-virtual {p0, v6, v7, v2}, Lr2c;->c(IILandroid/graphics/Bitmap$Config;)Lvc3;

    move-result-object v6

    invoke-virtual {v6}, Lvc3;->Z()Ljava/lang/Object;
    ...
    invoke-virtual {p0, p4, p5, v2}, Lr2c;->c(IILandroid/graphics/Bitmap$Config;)Lvc3;

    move-result-object p4

    invoke-virtual {p4}, Lvc3;->Z()Ljava/lang/Object;

    move-result-object p5

    check-cast p5, Landroid/graphics/Bitmap;

    invoke-virtual {p5, p6}, Landroid/graphics/Bitmap;->setHasAlpha(Z)V

    if-ne v2, p3, :cond_d

    if-nez p6, :cond_d

    invoke-virtual {p5, v3}, Landroid/graphics/Bitmap;->eraseColor(I)V
...
.method public abstract c(IILandroid/graphics/Bitmap$Config;)Lvc3;
.end method
