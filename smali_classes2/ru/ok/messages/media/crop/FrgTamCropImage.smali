...
.method public final O(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget p3, Ln1d;->frg_tam_crop_image:I
...
.method public final b0(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Lone/me/image/crop/view/ImageCropView;->getCropState()Lda4;
...
.method public final e0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    sget v0, Lq0d;->frg_tam_crop_image__iv_crop:I
    ...
    sget v0, Lq0d;->frg_tam_crop_image__rotate:I
    ...
    sget v0, Lq0d;->frg_tam_crop_image__flip:I
    ...
    sget v0, Lq0d;->frg_tam_crop_image__btn_clear:I
    ...
    sget v0, Lq0d;->frg_tam_crop_image__btn_done:I
    ...
    sget v0, Lq0d;->frg_tam_crop_image__btn_close:I
    ...
    invoke-static {v10, v0, p1}, Lwqi;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object p2, p2, Lone/me/image/crop/view/ImageCropView;->a:Lrr6;

    invoke-virtual {p2}, Lahg;->getMaxBitmapSize()I
    ...
    invoke-direct {v9, p2}, Ls6b;-><init>(Ljava/lang/Object;)V

    new-instance v3, Lfp0;

    move v8, v7

    invoke-direct/range {v3 .. v9}, Lfp0;-><init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILs6b;)V
    ...
    iput-object p1, p2, Lfp7;->G0:Lda4;
    :try_end_0
    ...
    invoke-static {v10, p2, p1}, Lwqi;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p2, v2}, Lefi;->r(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    invoke-direct {p2, p0, v2}, Lrl6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    invoke-static {p1, p2}, Lu8j;->a(Landroid/view/View;Lp6;)V

    iget-object p1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->w1:Landroid/widget/ImageButton;

    new-instance p2, Lrl6;

    invoke-direct {p2, p0, v1}, Lrl6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    invoke-direct {p2, p0, v0}, Lrl6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    invoke-static {v2, p2}, Luga;->c(II)Landroid/graphics/drawable/RippleDrawable;
