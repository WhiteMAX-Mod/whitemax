...
.method private final writeValue(Lgy7;Lru/ok/android/externcalls/analytics/events/EventItemValue;)V
    .locals 2
    ...
    invoke-virtual {p1, p2}, Le2;->l(I)V
    ...
    invoke-interface {p1, p2}, Lgy7;->h(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue-iurDigI(Lgy7;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue-4i0utlQ(Lgy7;Ljava/util/Map;)V

    :cond_5
    return-void
.end method

.method private final writeValue-4i0utlQ(Lgy7;Ljava/util/Map;)V
    .locals 2
...
.method private final writeValue-iurDigI(Lgy7;Ljava/util/Collection;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public final serialize(Lgy7;Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    .locals 2
    ...
    invoke-direct {p0, p1, v0}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue(Lgy7;Lru/ok/android/externcalls/analytics/events/EventItemValue;)V
