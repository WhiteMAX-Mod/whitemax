...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ln81;->i:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Ly8g;Lzkb;La3b;Lxt4;Ly6d;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ln81;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;

    iput-object p2, p0, Ln81;->b:Ly8g;

    iput-object p3, p0, Ln81;->c:Lzkb;

    iput-object p4, p0, Ln81;->d:La3b;

    iput-object p5, p0, Ln81;->e:Lxt4;

    iput-object p6, p0, Ln81;->f:Ly6d;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Ln81;->h:Ljava/util/ArrayList;
...
.method public final b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v0, p0, Ln81;->h:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Ln81;->h:Ljava/util/ArrayList;

    invoke-static {v1}, Lue3;->d0(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Ln81;->h:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Ldai;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object v3, v1, Ldai;->d:Ljava/lang/Long;
    ...
    invoke-interface {v3}, Ly8g;->localTimeMs()J
    ...
    iget-object v6, v1, Ldai;->a:Ljava/lang/String;

    iget-object v1, v1, Ldai;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
    ...
    iget-object v2, p0, Ln81;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v1, p0, Ln81;->b:Ly8g;

    invoke-interface {v1}, Ly8g;->getServerTimeMs()Ljava/lang/Long;

    move-result-object v1

    invoke-direct {v0, p1, p2, p3, v1}, Ldai;-><init>(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;Ljava/lang/Long;)V

    iget-object v2, p0, Ln81;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    if-nez v2, :cond_0

    iget-object p1, p0, Ln81;->h:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Ln81;->h:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v0, p0, Ln81;->b:Ly8g;

    invoke-interface {v0}, Ly8g;->getServerTimeMs()Ljava/lang/Long;
    ...
    invoke-interface {v0}, Ly8g;->localTimeMs()J
    ...
    iget-object p2, p0, Ln81;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final onTopologyUpdated(Lmdg;Lmdg;)V
    ...
    iget-object p1, p0, Ln81;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object p2, p0, Ln81;->c:Lzkb;

    invoke-virtual {p2, p1}, Lzkb;->j(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    iget-object p2, p0, Ln81;->d:La3b;

    iget-object p2, p2, La3b;->b:Ljava/lang/Object;

    check-cast p2, Lp64;

    iget-object p2, p2, Lp64;->a:Ljava/lang/String;
    ...
    iget-object p2, p0, Ln81;->e:Lxt4;

    invoke-virtual {p2, p1}, Lxt4;->j(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    invoke-virtual {p0, p1}, Ln81;->b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    iput-object p1, p0, Ln81;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
