...
# direct methods
.method public constructor <init>(Lhqa;Lorg/webrtc/CameraVideoCapturer;Ln2;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLy6d;)V
    .locals 4
    ...
    iput-object v0, p0, Ld12;->a:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Ld12;->b:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Ld12;->f:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Ld12;->g:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-object v2, p0, Ld12;->h:Ljava/lang/String;

    iput-object p7, p0, Ld12;->e:Ly6d;

    check-cast p1, Li52;

    new-instance p7, Lao6;

    new-instance v2, Lkob;

    new-instance v3, Lg32;

    iget-object p1, p1, Li52;->a:Ly6d;

    invoke-direct {v3, p1}, Lg32;-><init>(Ly6d;)V

    invoke-direct {v2, p2, v3, p1}, Lkob;-><init>(Lorg/webrtc/CameraVideoCapturer;Lg32;Ly6d;)V

    const/16 p1, 0x18

    invoke-direct {p7, p1, v2}, Lao6;-><init>(ILjava/lang/Object;)V

    iput-object p7, p0, Ld12;->c:Lao6;

    iput-object p3, p0, Ld12;->d:Ln2;

    invoke-virtual {v0, p4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v1, p5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iput-boolean p6, p0, Ld12;->i:Z
...
.method public final a()V
    ...
    iget-object v0, p0, Ld12;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Ld12;->i:Z

    if-eqz v1, :cond_0

    iget-object v2, p0, Ld12;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v2, p0, Ld12;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v3}, Lvs6;-><init>(I)V
    ...
    invoke-static {v6, v7, v8, v2, v9}, Lhf3;->g(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {v5, v6, v2}, Ly6d;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v4, v3, v8}, Lho7;->g(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, p0, Ld12;->e:Ly6d;

    new-instance v8, Ljava/lang/IllegalArgumentException;

    invoke-direct {v8, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v7, v6, v4, v8}, Ly6d;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Ld12;->e:Ly6d;

    const-string v7, "changeFormat, "

    const-string v8, "@"

    invoke-static {v7, v2, v5, v0, v8}, Lwy1;->k(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v4, p0, Ld12;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v8, v7, Lie8;->r:Ld12;

    if-eq p0, v8, :cond_d

    iget-object v8, v7, Lie8;->n:Ly6d;
    ...
    invoke-interface {v8, v10, v11, v9}, Ly6d;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v7, v7, Lie8;->y:Lubh;

    iget-object v8, v7, Lvt3;->c:Ljava/lang/Object;
    ...
    invoke-static {v10, v2, v0, v5}, Lho7;->g(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v8, v9, v10}, Ly6d;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v7, Lubh;->k:Lorg/webrtc/Size;
    ...
    invoke-virtual {v7}, Lubh;->u()V

    goto :goto_6

    :cond_e
    iget-boolean v4, p0, Ld12;->k:Z
    ...
    invoke-interface {v4, v6, v5}, Ly6d;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, p0, Ld12;->c:Lao6;

    iget-object v4, v4, Lao6;->b:Ljava/lang/Object;

    check-cast v4, Lkob;

    invoke-virtual {v4, v2, v0, v3}, Lkob;->changeCaptureFormat(III)V
    ...
    invoke-virtual {v0, v3, v4, v5}, Lkob;->startCapture(III)V

    iput-boolean v1, p0, Ld12;->k:Z
    :try_end_1
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lkob;->stopCapture()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Ld12;->k:Z
    :try_end_0
