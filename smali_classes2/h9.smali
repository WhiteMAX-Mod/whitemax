...
.method public constructor <init>(JLjava/lang/String;Ljava/util/List;Lone/me/profile/screens/addadmins/AddChatAdminsScreen;)V
    ...
    invoke-direct {p0, p5}, Lyb4;-><init>(Lone/me/sdk/arch/Widget;)V

    iput-wide p1, p0, Lh9;->v0:J

    iput-object p3, p0, Lh9;->w0:Ljava/lang/String;

    iput-object p4, p0, Lh9;->x0:Ljava/util/List;
...
.method public final E(Lytd;I)V
    ...
    :cond_0
    iget-object v0, p0, Lh9;->x0:Ljava/util/List;
    ...
    iget-wide v3, p0, Lh9;->v0:J

    invoke-direct {p2, v3, v4, v0, v2}, Lhd9;-><init>(JLbr2;I)V

    const/4 v0, 0x0

    iget-object v2, p0, Lh9;->w0:Ljava/lang/String;

    invoke-direct {v1, v2, p2, v0}, Lone/me/members/list/MembersListWidget;-><init>(Ljava/lang/String;Lhd9;Ltk4;)V

    sget-object p2, Lb54;->b:Lb54;

    invoke-virtual {v1, p2}, Lc54;->setRetainViewMode(Lb54;)V
