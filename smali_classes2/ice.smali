...
.method public constructor <init>(Lmu8;)V
    ...
    sget-object v0, Lyf4;->f:Lyf4;

    invoke-direct {p0, v0}, Ll98;-><init>(Lf9j;)V

    iput-object p1, p0, Lice;->o:Lmu8;
...
.method public final r(Lmid;I)V
    ...
    iget-object v0, p1, Lhce;->F0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    iget-object v1, p2, Lece;->Z:Landroid/net/Uri;

    iput-object p2, p1, Lhce;->H0:Lece;

    iget-object v2, p1, Lhce;->I0:Landroid/net/Uri;

    iget-object v3, p2, Lece;->d:Landroid/net/Uri;
    ...
    iget-object v2, p1, Lhce;->J0:Landroid/net/Uri;
    ...
    :cond_0
    iput-object v3, p1, Lhce;->I0:Landroid/net/Uri;

    iput-object v1, p1, Lhce;->J0:Landroid/net/Uri;

    invoke-static {v3}, Lsf7;->d(Landroid/net/Uri;)Lsf7;

    move-result-object v2

    iput-boolean v4, v2, Lsf7;->h:Z
    ...
    invoke-direct {v3, v5, v1}, Lrkb;-><init>(Landroid/content/Context;Landroid/net/Uri;)V

    iput-object v3, v2, Lsf7;->k:Ly6c;
    ...
    :cond_2
    iget-object p2, p2, Lece;->a:Lvd8;

    iget-object p2, p2, Lvd8;->v0:Lud8;
    ...
    :goto_0
    iget-object p1, p1, Lhce;->G0:Landroidx/appcompat/widget/AppCompatImageView;
...
.method public final t(Landroid/view/ViewGroup;I)Lmid;
    ...
    invoke-static {p1, p2}, Lr34;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v0}, Lr34;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v3 .. v8}, Luh1;-><init>(Ljava/lang/Object;Ljava/lang/Object;Landroid/graphics/drawable/Drawable;Lkotlin/coroutines/Continuation;I)V
    ...
    iget-object v1, p0, Lice;->o:Lmu8;

    move-object v3, p2

    invoke-direct/range {v0 .. v5}, Lhce;-><init>(Lmu8;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatImageView;Landroidx/appcompat/widget/AppCompatImageView;Landroid/widget/FrameLayout;)V
