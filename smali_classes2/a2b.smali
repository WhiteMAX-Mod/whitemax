...
.field public final B0:Lw3b;

.field public final C0:Ljava/util/LinkedHashMap;

.field public final D0:Lm8a;

.field public final E0:Ljava/lang/Object;

.field public final F0:Ljava/lang/Object;

.field public y0:Ly1b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Ln83;-><init>(Landroid/content/Context;)V

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, La2b;->z0:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, La2b;->A0:Landroid/graphics/Rect;

    new-instance v0, Lw3b;

    const/16 v1, 0xe

    invoke-direct {v0, p1, v1}, Lw3b;-><init>(Landroid/content/Context;I)V
    ...
    invoke-static {v0, v1, v2}, Lwsf;->j(Landroid/view/View;Landroid/text/TextPaint;Lt5g;)V
    ...
    invoke-static {v0, v1}, Lmfh;->k(Landroid/widget/TextView;Z)V
    ...
    iput-object v0, p0, La2b;->B0:Lw3b;

    new-instance v5, Ljava/util/LinkedHashMap;

    invoke-direct {v5}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v5, p0, La2b;->C0:Ljava/util/LinkedHashMap;

    new-instance v5, Lm8a;

    invoke-direct {v5}, Lm8a;-><init>()V

    iput-object v5, p0, La2b;->D0:Lm8a;
    ...
    iput-object v5, p0, La2b;->E0:Ljava/lang/Object;

    new-instance v5, Les9;

    const/16 v7, 0x1d

    invoke-direct {v5, p1, v7, p0}, Les9;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v6, v5}, Lipi;->b(ILcm6;)Lk18;

    move-result-object p1

    iput-object p1, p0, La2b;->F0:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Ln83;->setChipSpacing(I)V

    invoke-virtual {p0, v1}, Ln83;->setSingleLine(Z)V

    invoke-virtual {p0, v3}, Ln83;->setSingleSelection(Z)V
...
.method private final getCancelChipDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
    ...
    iget-object v0, p0, La2b;->F0:Ljava/lang/Object;
...
.method private final getMaterialThemeWrapper()Landroid/view/ContextThemeWrapper;
    ...
    iget-object v0, p0, La2b;->E0:Ljava/lang/Object;
...
.method public final a(JJLjava/lang/CharSequence;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, La2b;->C0:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0}, La2b;->getMaterialThemeWrapper()Landroid/view/ContextThemeWrapper;
    ...
    invoke-static {v3, v0, v2}, Lwsf;->j(Landroid/view/View;Landroid/text/TextPaint;Lt5g;)V
    ...
    invoke-static {v3, v12}, Lmfh;->k(Landroid/widget/TextView;Z)V
    ...
    invoke-virtual/range {v2 .. v10}, La2b;->b(Lcom/google/android/material/chip/Chip;ZJJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-direct/range {v2 .. v10}, Lx1b;-><init>(La2b;Lcom/google/android/material/chip/Chip;JJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    iget-object p1, p0, La2b;->y0:Ly1b;
...
.method public final b(Lcom/google/android/material/chip/Chip;ZJJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-direct {p0}, La2b;->getCancelChipDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
    ...
    invoke-direct/range {p3 .. p8}, Lpr0;-><init>(Ljava/lang/Object;JLjava/lang/Object;I)V

    new-instance p2, Lfi1;

    const/4 p5, 0x3

    invoke-direct {p2, p1, p5, p3}, Lfi1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object p2, p4, La2b;->D0:Lm8a;

    invoke-virtual {p2, p5, p6}, Lm8a;->d(J)Ljava/lang/Object;

    move-result-object p3

    if-nez p3, :cond_1

    new-instance p3, Lgxa;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-direct {p3, v0}, Lgxa;-><init>(Landroid/content/Context;)V

    invoke-virtual {p2, p5, p6, p3}, Lm8a;->h(JLjava/lang/Object;)V
    ...
    invoke-static {p7, p2}, Lfui;->a(Ljava/lang/CharSequence;Ljava/lang/Long;)Lmc0;

    move-result-object p2

    invoke-virtual {p3, p2, p8}, Lgxa;->b(Lmc0;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-direct {p0, p1}, La2b;->setChipStyle(Lcom/google/android/material/chip/Chip;)V
...
.method public final d()V
    ...
    invoke-virtual {p0}, La2b;->getEditText()Landroid/widget/EditText;

    move-result-object v0

    iget-object v1, p0, La2b;->z0:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/view/View;->getHitRect(Landroid/graphics/Rect;)V

    iget-object v0, p0, La2b;->A0:Landroid/graphics/Rect;
...
.method public final getCallback()Ly1b;
    .locals 1

    iget-object v0, p0, La2b;->y0:Ly1b;
...
.method public final getEditText()Landroid/widget/EditText;
    ...
    iget-object v0, p0, La2b;->B0:Lw3b;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, La2b;->D0:Lm8a;

    invoke-virtual {v0}, Lm8a;->a()V

    iget-object v0, p0, La2b;->C0:Ljava/util/LinkedHashMap;
...
.method public final onThemeChanged(Lyeb;)V
    ...
    iget-object v1, p0, La2b;->B0:Lw3b;
    ...
    iget-object p1, p0, La2b;->C0:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0, v0}, La2b;->setChipStyle(Lcom/google/android/material/chip/Chip;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, La2b;->F0:Ljava/lang/Object;
    ...
    invoke-static {p1, v0, v1}, Lz18;->e(Lmzg;Ljava/lang/String;I)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, La2b;->A0:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, La2b;->z0:Landroid/graphics/Rect;
...
.method public final setCallback(Ly1b;)V
    .locals 0

    iput-object p1, p0, La2b;->y0:Ly1b;
