...
.method public synthetic constructor <init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    iput-object p1, p0, Lrl6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
...
.method public final run()V
    ...
    iget-object v0, p0, Lrl6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;

    invoke-virtual {v0}, Lru/ok/messages/views/fragments/base/FrgBase;->u0()Ld6;
    ...
    iget-object v3, v3, Lone/me/image/crop/view/ImageCropView;->a:Lrr6;

    invoke-virtual {v3}, Lfp7;->getInitialMatrix()Landroid/graphics/Matrix;

    move-result-object v4

    iget-object v3, v3, Lahg;->t0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v3}, Lone/me/image/crop/view/ImageCropView;->getCropState()Lda4;
    ...
    :goto_1
    iget-object v1, v1, Lone/me/image/crop/view/ImageCropView;->a:Lrr6;

    invoke-virtual {v1}, Lahg;->getViewBitmap()Landroid/graphics/Bitmap;

    move-result-object v2

    invoke-virtual {v1}, Lahg;->getImageOutputPath()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1}, Lfp7;->getCropState()Lda4;
    ...
    iget-object v5, v1, Lda4;->c:[F

    iget-object v1, v1, Lda4;->a:Landroid/graphics/RectF;
    ...
    invoke-static {v4}, Lmei;->b(Landroid/graphics/Matrix;)F
    ...
    iget-object v2, p0, Lrl6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;

    invoke-direct {v0, v2, v1}, Lrl6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v1, Lkk3;

    const/4 v3, 0x1

    invoke-direct {v1, v3, v0}, Lkk3;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v3, v2, v4}, Lrl6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v4, Lsl6;

    const/4 v5, 0x0

    invoke-direct {v4, v5, v2}, Lsl6;-><init>(ILjava/lang/Object;)V

    new-instance v2, Lqu1;

    invoke-direct {v2, v4, v5, v3}, Lqu1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    :try_start_2
    new-instance v3, Lpk3;

    invoke-direct {v3, v2, v1}, Lpk3;-><init>(Lrk3;Lj0e;)V
    ...
    iget-object v0, v0, Lone/me/image/crop/view/ImageCropView;->a:Lrr6;

    const/4 v1, 0x0

    iput v1, v0, Lfp7;->E0:F

    invoke-virtual {v0}, Lfp7;->a()V
    ...
    iget-object v1, v0, Lru/ok/messages/views/fragments/base/FrgBase;->l1:Lwib;
    ...
    iget-object v2, v1, Lfp7;->B0:Landroid/graphics/RectF;
    ...
    iget-object v4, v1, Lahg;->t0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v1, v4}, Lahg;->setImageMatrix(Landroid/graphics/Matrix;)V
    ...
    iget-object v2, v1, Lfp7;->C0:Landroid/graphics/Matrix;
    ...
    iget-object v3, v1, Lfp7;->D0:Landroid/graphics/RectF;

    iget-object v1, v1, Lfp7;->B0:Landroid/graphics/RectF;
    ...
    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->a:Lrr6;

    iget-object v3, v2, Lfp7;->B0:Landroid/graphics/RectF;
    ...
    iget-object v6, v2, Lahg;->t0:Landroid/graphics/Matrix;

    const/high16 v7, 0x42b40000    # 90.0f

    invoke-virtual {v6, v7, v5, v3}, Landroid/graphics/Matrix;->postRotate(FFF)Z

    invoke-virtual {v2, v6}, Lahg;->setImageMatrix(Landroid/graphics/Matrix;)V

    iget-object v2, v0, Lru/ok/messages/media/crop/FrgTamCropImage;->u1:Lone/me/image/crop/view/ImageCropView;

    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->b:Ltkb;

    iget v3, v2, Ltkb;->s0:F

    div-float v3, v4, v3

    iput v3, v2, Ltkb;->s0:F

    iget-object v5, v2, Ltkb;->a:Landroid/graphics/RectF;

    invoke-virtual {v2, v5, v3}, Ltkb;->a(Landroid/graphics/RectF;F)V

    invoke-virtual {v2}, Ltkb;->b()V

    iget-object v3, v2, Ltkb;->L0:Lukb;
    ...
    invoke-virtual {v3, v5}, Lfp7;->setCropRect(Landroid/graphics/RectF;)V
    ...
    iget-object v3, v2, Lfp7;->C0:Landroid/graphics/Matrix;
    ...
    iget-object v4, v2, Lfp7;->D0:Landroid/graphics/RectF;

    iget-object v2, v2, Lfp7;->B0:Landroid/graphics/RectF;
    ...
    iget-object v1, v3, Lone/me/image/crop/view/ImageCropView;->a:Lrr6;

    iget-object v3, v1, Lfp7;->B0:Landroid/graphics/RectF;
    ...
    iget-object v5, v1, Lahg;->t0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v1, v5}, Lahg;->setImageMatrix(Landroid/graphics/Matrix;)V
