...
.method public final afterTextChanged(Landroid/text/Editable;)V
    ...
    invoke-static {p1}, Lkzi;->a(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    iput-object p1, v0, Lfbb;->d:Ljava/lang/CharSequence;

    iget-object v1, v0, Lfbb;->E0:Ljava/lang/Object;
    ...
    :cond_4
    iget-object v0, v0, Lfbb;->t0:Lcbb;
    ...
    iget-object v1, v0, Lru/ok/messages/media/mediabar/MediaBarPreviewLayout;->S0:Lpt8;
    ...
    invoke-virtual {v1}, Lru/ok/messages/media/mediabar/ActLocalMedias;->Q()Lsd8;

    move-result-object v1

    iget-object v1, v1, Lsd8;->f:Ldce;

    iput-object p1, v1, Ldce;->j:Ljava/lang/CharSequence;
    ...
    iget-object p1, v0, Lru/ok/messages/media/mediabar/MediaBarPreviewLayout;->Q0:Lsd8;
    ...
    :goto_3
    invoke-virtual {v0, p1}, Lru/ok/messages/media/mediabar/MediaBarPreviewLayout;->A(Z)V
...
.method public final onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    iget-object p2, v2, Lone/me/devmenu/utils/ValueBottomSheet;->G0:Lbbd;

    sget-object p3, Lone/me/devmenu/utils/ValueBottomSheet;->H0:[Lyy7;

    const/4 p4, 0x3

    aget-object p3, p3, p4

    invoke-interface {p2, v2, p3}, Lbbd;->D(Ljava/lang/Object;Lyy7;)Ljava/lang/Object;
    ...
    iget-object p2, v2, Lone/me/devmenu/tools/server/ServerPortBottomSheet;->E0:Lbbd;

    sget-object p3, Lone/me/devmenu/tools/server/ServerPortBottomSheet;->F0:[Lyy7;
    ...
    iget-object p2, v2, Lone/me/devmenu/tools/server/ServerHostBottomSheet;->J0:Lbbd;

    sget-object p3, Lone/me/devmenu/tools/server/ServerHostBottomSheet;->K0:[Lyy7;
    ...
    invoke-virtual {v2}, Lveb;->getEndIconDrawable()Lk18;

    move-result-object p2

    invoke-static {v2, p2}, Lveb;->b(Lveb;Lk18;)V

    invoke-virtual {v2}, Lveb;->getMaxLengthForLabel()I
    ...
    :cond_6
    invoke-static {v2, p2, v1}, Lveb;->c(Lveb;II)V

    invoke-static {v2}, Lveb;->a(Lveb;)V

    iget-object p1, v2, Lveb;->a:Lw3b;

    invoke-virtual {v2}, Lveb;->getTypingMode()Lteb;

    move-result-object p2

    sget-object p3, Lteb;->b:Lteb;
    ...
    iget-object p3, v2, Lveb;->d:Ljava/lang/Object;
    ...
    iget-object p2, v2, Lj8b;->v0:Landroid/widget/EditText;

    if-le p4, v0, :cond_b

    iget-boolean p3, v2, Lj8b;->o:Z

    if-nez p3, :cond_b

    iget-object p3, v2, Lj8b;->c:Lx2b;

    if-eqz p3, :cond_b

    iget-object p3, p3, Lx2b;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lj8b;->getPhoneFormatterProvider()Li8b;

    move-result-object p4

    if-eqz p4, :cond_a

    invoke-interface {p4, p3, p1}, Li8b;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_a
    :goto_0
    iget-object p3, v2, Lj8b;->w0:Lp3;

    invoke-virtual {p2, p3}, Landroid/widget/TextView;->removeTextChangedListener(Landroid/text/TextWatcher;)V

    invoke-virtual {v2, p1}, Lj8b;->setText(Ljava/lang/CharSequence;)V

    iget-object p1, v2, Lj8b;->w0:Lp3;
    ...
    sget-object p2, Lone/me/devmenu/logsviewer/LogsViewerScreen;->X:[Lyy7;

    invoke-virtual {v2}, Lone/me/devmenu/logsviewer/LogsViewerScreen;->y0()Lsj8;
    ...
    invoke-direct {v0, p2, p1, p3}, Lrj8;-><init>(Lsj8;Ljava/lang/CharSequence;Lkotlin/coroutines/Continuation;)V
    ...
    iget-object p3, p2, Lsj8;->s0:Lt9f;

    sget-object p4, Lsj8;->u0:[Lyy7;

    aget-object p4, p4, v1

    invoke-virtual {p3, p2, p4, p1}, Lt9f;->O(Ljava/lang/Object;Lyy7;Ljava/lang/Object;)V

    invoke-virtual {p2}, Lsj8;->u()V

    goto :goto_3

    :cond_d
    :goto_2
    iget-object p1, p2, Lsj8;->s0:Lt9f;

    sget-object p4, Lsj8;->u0:[Lyy7;

    aget-object p4, p4, v1

    invoke-virtual {p1, p2, p4, p3}, Lt9f;->O(Ljava/lang/Object;Lyy7;Ljava/lang/Object;)V

    iget-object p1, p2, Lsj8;->Z:Ltcf;
    ...
    :goto_4
    iget-object p2, p2, Ljxb;->s0:Ltcf;
    ...
    :cond_f
    invoke-virtual {p2, p3, p1}, Ltcf;->m(Ljava/lang/Object;Ljava/lang/Object;)Z
