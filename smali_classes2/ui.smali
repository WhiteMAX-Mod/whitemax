...
.method public final run()V
    ...
    iget-boolean v2, v3, Lr8a;->b:Z

    if-eqz v2, :cond_1

    iput-boolean v6, v3, Lr8a;->b:Z

    iput-boolean v6, v3, Lr8a;->c:Z

    invoke-virtual {v3}, Lr8a;->a()V
    ...
    sget-object v2, Lx71;->o:Lx71;

    invoke-virtual {v0, v2, v5}, Lk01;->l(Lx71;Ljava/lang/Object;)V
    ...
    :cond_3
    iget-boolean v3, v3, Lr8a;->b:Z

    if-eqz v3, :cond_4

    iget-boolean v3, v0, Lk01;->Y0:Z

    if-nez v3, :cond_4

    iget-object v3, v0, Lk01;->g1:Lzpb;

    goto :goto_2

    :cond_4
    iget-object v3, v0, Lk01;->h1:Lzpb;
    ...
    iput-object v3, v2, Lds1;->r:Lzpb;

    iget-object v2, v2, Lds1;->m:Lus8;

    if-eqz v2, :cond_8

    iput-object v3, v2, Lus8;->f:Lzpb;
    ...
    :cond_7
    invoke-virtual {v2, v3}, Lds1;->R(Lzpb;)V
    :try_end_1
    ...
    :goto_3
    iget-object v0, v0, Lk01;->P:Ly6d;

    const-string v3, "Error apply screen capture stopped state (fast="

    const-string v4, ")"

    invoke-static {v3, v4, v1}, Lxrf;->p(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;

    move-result-object v1

    const-string v3, "OKRTCCall"

    invoke-interface {v0, v3, v1, v2}, Ly6d;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v0, v0, Lpze;->m:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v2, v2, Lsz0;->b:Lfr1;

    packed-switch v3, :pswitch_data_1

    iget-object v2, v2, Lfr1;->k:Lss3;

    iget-boolean v3, v2, Lss3;->i:Z
    ...
    :cond_a
    iput-boolean v1, v2, Lss3;->i:Z

    iget-object v3, v2, Lss3;->c:Lrs3;

    iget-boolean v3, v3, Lrs3;->a:Z
    ...
    iget-object v0, v0, Lj0c;->J0:Landroid/widget/TextView;
    ...
    :try_start_2
    iget-object v2, v0, Lt9b;->Z:Ljava/util/concurrent/ScheduledFuture;
    ...
    iget-object v2, v0, Lt9b;->a:Ljava/util/concurrent/Callable;

    invoke-interface {v2}, Ljava/util/concurrent/Callable;->call()Ljava/lang/Object;

    move-result-object v2

    iput-object v2, v0, Lt9b;->X:Ljava/lang/Object;

    if-nez v1, :cond_10

    iget-object v1, v0, Lt9b;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v1, v4}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    iget-object v1, v0, Lt9b;->o:Ljava/util/concurrent/CountDownLatch;
    ...
    :goto_8
    iget-object v2, v0, Lt9b;->Y:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v1, v0, Lt9b;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v1, v4}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    iget-object v0, v0, Lt9b;->o:Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-virtual {v0, v6}, Lez1;->I(Z)V
    ...
    :cond_13
    iput-boolean v1, v0, Liy1;->a:Z

    if-eqz v1, :cond_14

    iget-boolean v1, v0, Liy1;->b:Z

    if-eqz v1, :cond_15

    iget-object v1, v0, Liy1;->c:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v1}, Ltu1;->d(Ljava/lang/Throwable;)Z

    iput-object v5, v0, Liy1;->g:Ljava/lang/Object;
    ...
    iget-wide v2, v2, Ljf2;->a:J

    iget-object v4, v0, Lvw1;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {v4, v2, v3, v5, v6}, Lqi9;->k(JJ)Ljava/util/ArrayList;

    move-result-object v2

    iget-object v3, v0, Lvw1;->d:Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-virtual {v3}, Ljava/util/concurrent/CopyOnWriteArrayList;->size()I

    move-result v3

    invoke-virtual {v0, v3, v2}, Lvw1;->a(ILjava/util/List;)V
    ...
    invoke-static {v7, v3}, Lwqi;->d(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v2}, Ljava/util/ArrayList;->isEmpty()Z

    move-result v3

    iput-boolean v3, v0, Lvw1;->b:Z
    ...
    iget-boolean v2, v0, Lbhd;->W:Z

    if-eq v2, v1, :cond_1b

    iput-boolean v1, v0, Lbhd;->W:Z
    ...
    :cond_1c
    iput-boolean v3, v0, Ldm5;->e1:Z

    iget-object v0, v0, Ldm5;->w0:Lcb6;

    new-instance v4, Lj21;

    invoke-direct {v4, v3, v2}, Lj21;-><init>(ZI)V

    invoke-virtual {v0, v1, v4}, Lcb6;->j(ILoa8;)V
    ...
    invoke-direct {v3, v2, v4}, Lj21;-><init>(ZI)V

    invoke-virtual {v0, v1, v3}, Lua8;->f(ILpa8;)V
