...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lrm2;->a:Landroid/graphics/drawable/ColorDrawable;

    new-instance v0, Lqm2;

    const/4 v2, 0x0

    invoke-direct {v0, p0, v2}, Lqm2;-><init>(Lrm2;I)V
    ...
    invoke-direct {v0, p0, v3}, Lqm2;-><init>(Lrm2;I)V

    invoke-static {v2, v0}, Lipi;->b(ILcm6;)Lk18;

    move-result-object v0

    iput-object v0, p0, Lrm2;->c:Ljava/lang/Object;
    ...
    invoke-direct {v5, v3}, Lhr6;-><init>(Landroid/content/res/Resources;)V

    iput-object v1, v5, Lhr6;->d:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v5}, Lhr6;->a()Lgr6;

    move-result-object v1

    invoke-virtual {v0, v1}, Lo45;->setHierarchy(Ll45;)V

    iput-object v0, p0, Lrm2;->d:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    new-instance v1, Lm3;

    const/16 v3, 0x1b

    invoke-direct {v1, p1, v3, p0}, Lm3;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final onThemeChanged(Lyeb;)V
    ...
    iget-object v1, p0, Lrm2;->a:Landroid/graphics/drawable/ColorDrawable;
    ...
    :cond_0
    iget-object p1, p0, Lrm2;->c:Ljava/lang/Object;
...
.method public final setItem(Lwb9;)V
    .locals 8

    iget-boolean v0, p1, Lwb9;->u0:Z

    const/16 v1, 0x8

    const/4 v2, 0x1

    iget-object v3, p0, Lrm2;->o:Ljava/lang/Object;

    iget-object v4, p0, Lrm2;->d:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    const/4 v5, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v4, v5}, Lo45;->setController(Li45;)V

    invoke-virtual {v4}, Lo45;->getHierarchy()Ll45;
    ...
    invoke-virtual {p1, v0, v2}, Lgr6;->i(Landroid/graphics/drawable/Drawable;I)V
    ...
    :cond_2
    iget-object v0, p1, Lwb9;->d:Landroid/net/Uri;
    ...
    :goto_0
    iget-object v6, p1, Lwb9;->s0:Landroid/net/Uri;

    if-eqz v6, :cond_3

    invoke-static {v6}, Lsf7;->d(Landroid/net/Uri;)Lsf7;

    move-result-object v6

    invoke-virtual {v6}, Lsf7;->a()Lrf7;
    ...
    invoke-virtual {v4, v0, v6}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->i(Lrf7;Lrf7;)V
    ...
    iget-object p1, p1, Lwb9;->X:Ljava/lang/Long;
    ...
    sget-object v7, Lq1g;->a0:Lbwf;

    invoke-static {v6}, Lnca;->d(Landroid/content/Context;)Lq1g;
    ...
    invoke-static {v4, v6, p1}, Lcei;->h(IILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, p1}, Ls9j;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;)V

    invoke-static {v0, v5}, Ls9j;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;)V
