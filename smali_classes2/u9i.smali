...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Lu9i;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lu9i;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v1, v0}, Ldui;->c(ILjava/lang/String;)I
    ...
    invoke-static {v1, p1}, Ldui;->c(ILjava/lang/String;)I
    ...
    iput v1, p0, Lu9i;->programId:I

    const-string v2, "glCreateProgram"

    invoke-static {v2}, Ldui;->b(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Ldui;->b(Ljava/lang/String;)V
    ...
    iput v0, p0, Lu9i;->aVertexCoordLoc:I

    invoke-static {v0, p1}, Ldui;->a(ILjava/lang/String;)V
    ...
    iput v2, p0, Lu9i;->aTextureCoordLoc:I

    invoke-static {v2, p1}, Ldui;->a(ILjava/lang/String;)V
    ...
    iput v3, p0, Lu9i;->mvpMatrixLoc:I

    invoke-static {v3, p1}, Ldui;->a(ILjava/lang/String;)V
    ...
    iput v3, p0, Lu9i;->texMatrixLoc:I
    ...
    iput v3, p0, Lu9i;->textureLocation:I
    ...
    iput v1, p0, Lu9i;->alphaLocation:I

    invoke-static {v3, p1}, Ldui;->a(ILjava/lang/String;)V

    new-instance p1, Ll9i;

    invoke-direct {p1, v0, v2}, Ll9i;-><init>(II)V

    iput-object p1, p0, Lu9i;->frame:Ll9i;
...
.method public getTextureCoordLoc()I
    ...
    iget v0, p0, Lu9i;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget v0, p0, Lu9i;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lu9i;->firstFreeTexture:I
    ...
    iget p1, p0, Lu9i;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Lu9i;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Lu9i;->frame:Ll9i;

    iget-object v0, v0, Ll9i;->a:Lr9i;

    invoke-interface {v0}, Lr9i;->a()V

    iget v0, p0, Lu9i;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Lu9i;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    .line 2
    iget-object v0, p0, Lu9i;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Lu9i;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Lu9i;->texMat:[F
...
.method public use()V
    ...
    iput v0, p0, Lu9i;->firstFreeTexture:I

    iget-object v1, p0, Lu9i;->mvpMat:[F
    ...
    iput-object v1, p0, Lu9i;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Lu9i;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Lu9i;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Lu9i;->programId:I
    ...
    iget v1, p0, Lu9i;->mvpMatrixLoc:I

    iget-object v2, p0, Lu9i;->mvpMat:[F
    ...
    iget v2, p0, Lu9i;->texMatrixLoc:I

    iget-object v4, p0, Lu9i;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Ldui;->b(Ljava/lang/String;)V

    iget v0, p0, Lu9i;->textureLocation:I

    invoke-virtual {p0}, Lu9i;->getTarget()I

    move-result v1

    iget v2, p0, Lu9i;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Lu9i;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lu9i;->alphaLocation:I

    iget v1, p0, Lu9i;->alpha:F
    ...
    iget-object v3, p0, Lu9i;->customParams:Ljava/util/HashMap;
