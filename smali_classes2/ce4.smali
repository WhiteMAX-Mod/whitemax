...
# direct methods
.method public constructor <init>(Lae4;La93;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    iput-object p2, p0, Lce4;->a:La93;

    const/16 p2, 0x1e

    iput p2, p0, Lce4;->b:I

    iput-object p1, p0, Lce4;->c:Lae4;

    new-instance p1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object p1, p0, Lce4;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object p1, p0, Lce4;->o:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lce4;->Z:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {p1}, Ljava/util/concurrent/locks/ReentrantLock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object p1

    iput-object p1, p0, Lce4;->s0:Ljava/util/concurrent/locks/Condition;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lce4;->t0:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final run()V
    ...
    iget-object v0, p0, Lce4;->t0:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v2, p0, Lce4;->c:Lae4;
    ...
    iget-object v2, v2, Lae4;->a:Lorg/webrtc/DataChannel;
    ...
    iget-object v0, p0, Lce4;->X:Lyj;

    if-nez v0, :cond_7

    iget-object v0, p0, Lce4;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    :cond_4
    :try_start_1
    iget-object v0, p0, Lce4;->Z:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :try_start_2
    iget-object v2, p0, Lce4;->s0:Ljava/util/concurrent/locks/Condition;
    ...
    :cond_9
    iget-object v0, p0, Lce4;->o:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_17
    iget-object v2, p0, Lce4;->a:La93;

    array-length v4, v8

    iget-object v2, v2, La93;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v7, v8}, Lae4;->e(I[B)Z
    ...
    iget-object v2, v2, La93;->b:Ljava/lang/Object;

    check-cast v2, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iput-object v1, p0, Lce4;->X:Lyj;
    :try_end_6
