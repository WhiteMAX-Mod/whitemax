...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Ly60;->v0:Landroid/graphics/Paint;

    new-instance v6, Landroid/graphics/Paint;

    invoke-direct {v6, v3}, Landroid/graphics/Paint;-><init>(Landroid/graphics/Paint;)V

    iput-object v6, p0, Ly60;->w0:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Ly60;->x0:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Ly60;->y0:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Path;

    invoke-direct {v3}, Landroid/graphics/Path;-><init>()V

    iput-object v3, p0, Ly60;->z0:Landroid/graphics/Path;
    ...
    iput-object p1, p0, Ly60;->A0:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {p0, p1}, Ly60;->onThemeChanged(Lyeb;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Ly60;->s0:Ljava/util/List;
    ...
    iget-object v8, p0, Ly60;->z0:Landroid/graphics/Path;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Ly60;->z0:Landroid/graphics/Path;
    ...
    :cond_0
    iget-boolean v2, p0, Ly60;->u0:Z

    const/4 v3, 0x2

    const/4 v4, 0x6

    iget-object v5, p0, Ly60;->v0:Landroid/graphics/Paint;

    const/4 v6, 0x0

    if-nez v2, :cond_3

    iget-boolean v2, p0, Ly60;->D0:Z
    ...
    invoke-static {v4, v8, v3, v7}, Lu45;->d(FFII)I
    ...
    iget-wide v8, p0, Ly60;->o:J

    long-to-float v4, v8

    iget-wide v8, p0, Ly60;->C0:J
    ...
    iget-object v9, p0, Ly60;->w0:Landroid/graphics/Paint;
    ...
    iget-object v2, p0, Ly60;->y0:Landroid/graphics/Paint;

    invoke-virtual {p1, v8, v0, v1, v2}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    iget-object v1, p0, Ly60;->x0:Landroid/graphics/Paint;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p1, p0, Ly60;->E0:Lx60;

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Ly60;->getPeaksCount()I
    ...
    sget-object p2, Lone/me/sdk/messagewrite/recordcontrols/RecordControlsWidget;->g1:[Lyy7;

    invoke-virtual {p1}, Lone/me/sdk/messagewrite/recordcontrols/RecordControlsWidget;->S0()Lzed;

    move-result-object p1

    invoke-virtual {p1}, Lzed;->z()Lw60;

    move-result-object v1

    if-eqz v1, :cond_0

    iget-object p1, v1, Lw60;->f:Lkotlinx/coroutines/internal/ContextScope;
...
.method public final onThemeChanged(Lyeb;)V
    ...
    :goto_0
    iget-object v1, p0, Ly60;->v0:Landroid/graphics/Paint;

    invoke-virtual {v1, v0}, Landroid/graphics/Paint;->setColor(I)V

    invoke-interface {p1}, Lyeb;->getIcon()Lnb7;

    iget-object v0, p0, Ly60;->x0:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Ly60;->y0:Landroid/graphics/Paint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Ly60;->w0:Landroid/graphics/Paint;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1}, Ly60;->b(Landroid/view/MotionEvent;)F

    move-result v0

    iget-wide v3, p0, Ly60;->C0:J
    ...
    iput-wide v0, p0, Ly60;->o:J

    iget-object v0, p0, Ly60;->E0:Lx60;
    ...
    invoke-virtual {v1}, Ly60;->getDuration()J
    ...
    invoke-static {v3, v4}, Lz7i;->b(J)Ljava/lang/String;

    move-result-object p1

    iget-object v0, v0, Laqc;->c:Ljava/lang/Object;

    check-cast v0, Lrkh;

    iget-object v0, v0, Lrkh;->u0:Landroid/widget/TextView;
    ...
    iget-object v3, v0, Lzed;->y0:Lhbd;
    ...
    invoke-interface {v0, v3, v4}, Lga8;->seekTo(J)V
...
.method public final setLinesColor(I)V
    ...
    iget-object v0, p0, Ly60;->v0:Landroid/graphics/Paint;
...
.method public final setListener(Lx60;)V
    .locals 0

    iput-object p1, p0, Ly60;->E0:Lx60;
...
.method public final setPauseRecordingData(Ljava/util/List;)V
    ...
    iput-object p1, p0, Ly60;->s0:Ljava/util/List;

    const/4 p1, 0x1

    iput-boolean p1, p0, Ly60;->t0:Z

    iget-object p1, p0, Ly60;->A0:Landroid/animation/ValueAnimator;

    invoke-virtual {p1}, Landroid/animation/ValueAnimator;->cancel()V

    const/4 p1, 0x0

    iput p1, p0, Ly60;->B0:F

    iget-object p1, p0, Ly60;->z0:Landroid/graphics/Path;
...
.method public final setShiftOffset(J)V
    ...
    iget-object v0, p0, Ly60;->A0:Landroid/animation/ValueAnimator;
