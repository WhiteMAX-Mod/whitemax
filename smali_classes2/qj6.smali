...
.field public volatile Y:Lek6;

.field public volatile Z:Lek6;
...
.field public final o:Lbtd;

.field public volatile s0:J

.field public final t0:Lg9g;

.field public final u0:Lg9g;
...
# direct methods
.method public constructor <init>(Ly6d;Lbtd;)V
    .locals 4
    ...
    iput-object v0, p0, Lqj6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Lqj6;->d:Ly6d;

    iput-object p2, p0, Lqj6;->o:Lbtd;
    ...
    iput-object p1, p0, Lqj6;->c:Lu44;

    new-instance p1, Lg9g;

    invoke-direct {p1}, Lg9g;-><init>()V

    iput-object p1, p0, Lqj6;->t0:Lg9g;

    new-instance p1, Lg9g;

    invoke-direct {p1}, Lg9g;-><init>()V

    iput-object p1, p0, Lqj6;->u0:Lg9g;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Lqj6;->w0:Z

    iget-object v0, p0, Lqj6;->X:Lorg/webrtc/VpxEncoderWrapper;
    ...
    iput-object v0, p0, Lqj6;->X:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iget-object v0, p0, Lqj6;->t0:Lg9g;
    ...
    iput-wide v2, p0, Lqj6;->s0:J

    :cond_0
    iget-object v0, p0, Lqj6;->Y:Lek6;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lqj6;->Y:Lek6;

    iget-boolean v2, v0, Lek6;->a:Z
    ...
    iput-boolean v1, v0, Lek6;->h:Z

    :cond_2
    iget-object v1, v0, Lek6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Lek6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, v0, Lek6;->g:Lj8i;

    invoke-static {p1}, Lek6;->b(Lj8i;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Lqj6;->Z:Lek6;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Lqj6;->x0:J

    iget-wide v7, p0, Lqj6;->b:J
    ...
    iget-object v5, v2, Lek6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Lek6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Lqj6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Ly6d;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Lqj6;->x0:J

    iget-object p1, p0, Lqj6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Lqj6;->c:Lu44;

    new-instance v0, Lse5;

    const/16 v3, 0xb

    invoke-direct {v0, p0, v2, v1, v3}, Lse5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final onFrameDropped(I)V
    ...
    iget-object p1, p0, Lqj6;->u0:Lg9g;
