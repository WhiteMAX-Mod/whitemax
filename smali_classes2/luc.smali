...
.method public constructor <init>(Lkuc;)V
    ...
    iput-object v0, p0, Lluc;->b:Ljava/lang/String;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Lluc;->c:Landroid/graphics/Paint;

    iget-object v0, p1, Lkuc;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Lkuc;->c:Lyt0;

    invoke-virtual {p0, p1}, Lluc;->d(Lyt0;)V
...
.method public final chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;)V
    ...
    .line 1
    invoke-virtual/range {v0 .. v7}, Lluc;->chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;Landroid/text/TextPaint;)V
...
.method public final copy()Lg74;
    ...
    invoke-direct {v0, v1}, Lluc;-><init>(Lkuc;)V
...
.method public final d(Lyt0;)V
    ...
    iget-object v0, p0, Lluc;->a:Lkuc;

    iput-object p1, v0, Lkuc;->c:Lyt0;
    ...
    iget-object p1, v0, Lkuc;->e:Landroid/graphics/drawable/Drawable;
...
.method public final drawLeadingMargin(Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIIILjava/lang/CharSequence;IIZLandroid/text/Layout;)V
    ...
    iget-object v6, v1, Lluc;->a:Lkuc;

    iget-object v7, v6, Lkuc;->f:Lwsc;

    iget-object v8, v6, Lkuc;->s:Landroid/graphics/Path;

    iget v9, v6, Lkuc;->j:I

    iget v10, v6, Lkuc;->g:I

    iget v11, v6, Lkuc;->k:I

    iget v12, v6, Lkuc;->q:F

    if-eqz v7, :cond_1

    invoke-virtual {v7}, Lwsc;->getAsInt()I
    ...
    iget-object v7, v1, Lluc;->b:Ljava/lang/String;
    ...
    iget-object v13, v1, Lluc;->c:Landroid/graphics/Paint;
    ...
    invoke-virtual/range {p5 .. p12}, Lluc;->c(Landroid/graphics/Paint;Landroid/graphics/Canvas;IFIFF)V
    ...
    iget-object v7, v6, Lkuc;->r:Landroid/graphics/Path;
    ...
    :try_start_5
    iget-object v7, v6, Lkuc;->v:Landroid/graphics/Path;
    ...
    iget-object v8, v6, Lkuc;->u:Landroid/graphics/Path;
    ...
    iget-object v2, v6, Lkuc;->t:Landroid/graphics/Path;
    ...
    :try_start_8
    iget-object v2, v6, Lkuc;->w:Landroid/graphics/Path;
    ...
    :cond_1a
    iget-object v0, v6, Lkuc;->e:Landroid/graphics/drawable/Drawable;
...
.method public final hashCode()I
    ...
    invoke-virtual {v0}, Lkuc;->hashCode()I
...
.method public final updateDrawState(Landroid/text/TextPaint;)V
    ...
    iget-object v1, v0, Lkuc;->d:Lt5g;

    iget-object v2, v0, Lkuc;->a:Landroid/content/Context;

    iget-object v0, v0, Lkuc;->b:Lhbd;
...
.method public final updateMeasureState(Landroid/text/TextPaint;)V
    ...
    iget-object p1, v0, Lkuc;->f:Lwsc;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lwsc;->getAsInt()I
