...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lvob;Lc28;)V
    .locals 0
    ...
    iput-object p2, p0, Lae;->c:Lvob;

    iput-object p3, p0, Lae;->d:Lc28;
...
# virtual methods
.method public final a(Le1e;Ljava/lang/String;)Landroid/net/Uri;
    .locals 7

    invoke-interface {p1}, Le1e;->i()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p1}, Le1e;->a()Luz9;
    ...
    invoke-direct {v0, v5, p2}, Limb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    iget-object p2, v1, Luz9;->a:Ljava/lang/String;

    new-instance v1, Limb;

    const-string v5, "mime_type"

    invoke-direct {v1, v5, p2}, Limb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v5, v6, p2}, Limb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v3, v4, p2}, Limb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v0, v1, v5, v2, v3}, [Limb;
    ...
    :cond_a
    invoke-interface {p1}, Le1e;->k()Ljava/lang/Integer;
    ...
    :cond_b
    invoke-interface {p1}, Le1e;->getWidth()Ljava/lang/Integer;
    ...
    :cond_c
    invoke-interface {p1}, Le1e;->getHeight()Ljava/lang/Integer;
    ...
    invoke-interface {p1}, Le1e;->h()Landroid/net/Uri;
    ...
    invoke-interface {p1, v5, v3}, Le1e;->c(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    invoke-static {p1, v3}, Ld1e;->e(Landroid/content/Context;Landroid/net/Uri;)V

    return-object v3
.end method

.method public final b(Le1e;Ljava/lang/String;)Landroid/net/Uri;
    .locals 3

    new-instance v0, Ljava/io/File;

    iget-object v1, p0, Lae;->c:Lvob;

    invoke-virtual {v1}, Lvob;->a()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v0, v2, p2}, Ljava/io/File;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {p1, v0}, Le1e;->n(Ljava/io/File;)V

    iget-object p1, v1, Lvob;->a:Landroid/content/Context;
...
.method public final d()Lc28;
    .locals 1

    iget-object v0, p0, Lae;->d:Lc28;
