...
.method public final F(Llc9;)V
    ...
    iget-boolean v3, p1, Llc9;->t0:Z

    invoke-virtual {v0, v3}, Lv0b;->setEnabled(Z)V

    iget-object v3, p1, Llc9;->b:Ljava/lang/String;

    invoke-virtual {v0, v3}, Lv0b;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v3, p1, Llc9;->d:Ls5g;
    ...
    iget-boolean v3, p1, Llc9;->Y:Z

    invoke-virtual {v0, v3}, Lv0b;->setVerified(Z)V

    iget-object v3, p1, Llc9;->w0:Ls5g;
    ...
    :goto_0
    invoke-virtual {v0, v3}, Lv0b;->setAlias(Ljava/lang/CharSequence;)V

    invoke-virtual {v0}, Lv0b;->f()V

    invoke-virtual {v0, v4}, Lv0b;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v3, p1, Llc9;->X:Ljava/lang/CharSequence;

    iget-object p1, p1, Llc9;->o:Landroid/net/Uri;
...
.method public final bridge synthetic z(Lt98;)V
    ...
    invoke-virtual {p0, p1}, Lmc9;->F(Llc9;)V
