...
# instance fields
.field public final A0:Lf8b;

.field public final B0:Lf8b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lytc;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Lytc;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-interface {v10}, Lyeb;->getIcon()Lnb7;
    ...
    iput-object v5, v0, Lytc;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v10, Lf8b;

    invoke-direct {v10, v1}, Lf8b;-><init>(Landroid/content/Context;)V
    ...
    sget-object v2, Lc8b;->b:Lc8b;

    invoke-virtual {v10, v2}, Lf8b;->setMode(Lc8b;)V
    ...
    invoke-virtual {v10, v11, v9, v13}, Lf8b;->a(FILjava/lang/String;)V

    new-instance v9, Lstc;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lstc;-><init>(Lytc;I)V

    invoke-static {v10, v9}, Lf8j;->e(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v10, v0, Lytc;->v0:Lf8b;
    ...
    invoke-virtual {v7, v9}, Lv1a;->y(Landroid/view/View;)Lyeb;
    ...
    iput-object v9, v0, Lytc;->w0:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v7, v13}, Lv1a;->y(Landroid/view/View;)Lyeb;

    move-result-object v6

    invoke-interface {v6}, Lyeb;->b()Lbf0;

    move-result-object v6

    iget v6, v6, Lbf0;->g:I

    invoke-static {v3, v6}, Lcei;->k(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-virtual {v7, v3}, Lv1a;->y(Landroid/view/View;)Lyeb;
    ...
    invoke-static {v6, v7}, Lcei;->k(Landroid/graphics/drawable/Drawable;I)V
    ...
    iput-object v13, v0, Lytc;->x0:Landroid/widget/LinearLayout;

    new-instance v3, Lf8b;

    invoke-direct {v3, v1}, Lf8b;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Lf8b;->setMode(Lc8b;)V

    new-instance v6, Lstc;

    const/4 v7, 0x1

    invoke-direct {v6, v0, v7}, Lstc;-><init>(Lytc;I)V

    invoke-static {v3, v6}, Lf8j;->e(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lytc;->y0:Lf8b;

    new-instance v6, Lg12;

    invoke-direct {v6, v1}, Lg12;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v7, v0, v8}, Lstc;-><init>(Lytc;I)V

    invoke-static {v6, v7}, Lf8j;->e(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lytc;->z0:Lg12;

    new-instance v7, Lf8b;

    invoke-direct {v7, v1}, Lf8b;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Lf8b;->setMode(Lc8b;)V
    ...
    invoke-virtual {v7, v11, v8, v9}, Lf8b;->a(FILjava/lang/String;)V

    new-instance v8, Lstc;

    const/4 v9, 0x3

    invoke-direct {v8, v0, v9}, Lstc;-><init>(Lytc;I)V

    invoke-static {v7, v8}, Lf8j;->e(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lytc;->A0:Lf8b;

    new-instance v8, Lf8b;

    invoke-direct {v8, v1}, Lf8b;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Lf8b;->setMode(Lc8b;)V

    new-instance v2, Lstc;

    const/4 v9, 0x4

    invoke-direct {v2, v0, v9}, Lstc;-><init>(Lytc;I)V

    invoke-static {v8, v2}, Lf8j;->e(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Lytc;->B0:Lf8b;
    ...
    invoke-direct {v3, v2, v1, v7}, Leo7;-><init>(ILms0;I)V

    const/4 v8, 0x0

    invoke-static {v6, v3, v8}, Lzfi;->b(Landroid/view/View;Leo7;Lem6;)V

    iput-object v6, v0, Lytc;->C0:Landroid/widget/FrameLayout;

    new-instance v1, Lttc;

    const/4 v3, 0x0

    invoke-direct {v1, v0, v3}, Lttc;-><init>(Lytc;I)V

    invoke-static {v2, v1}, Lipi;->b(ILcm6;)Lk18;

    move-result-object v1

    iput-object v1, v0, Lytc;->D0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lytc;->E0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lytc;->F0:Ljava/lang/Object;
...
.method public static final synthetic a(Lytc;)Z
    .locals 0

    invoke-direct {p0}, Lytc;->getCanRecordingVideo()Z
...
.method public static final b(Lytc;Li02;)V
    .locals 6
    ...
    invoke-direct {p0}, Lytc;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Lytc;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Lytc;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Lytc;->y0:Lf8b;

    sget v2, Lytc;->G0:F

    invoke-virtual {v1, v0, v5, v2}, Lf8b;->b(Landroid/graphics/drawable/Drawable;Ljava/lang/String;F)V

    invoke-virtual {p0}, Lytc;->getCameraApi()Lj02;
    ...
    invoke-interface {p0, p1}, Lj02;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Lytc;FFFFF)V
    .locals 2

    iget-object v0, p0, Lytc;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Lytc;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lytc;->C0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lytc;->D0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lytc;->F0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lytc;->E0:Ljava/lang/Object;
...
.method public final getCameraApi()Lj02;
    .locals 1

    iget-object v0, p0, Lytc;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
