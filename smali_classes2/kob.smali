...
.method public constructor <init>(Lh97;)V
    ...
    .line 7
    sget-object p1, Lrha;->x0:Lrha;

    iput-object p1, p0, Lkob;->d:Ljava/lang/Object;

    .line 8
    sget-object p1, Ly64;->a:Llcj;

    iput-object p1, p0, Lkob;->o:Ljava/lang/Object;
...
.method public constructor <init>(Lorg/webrtc/CameraVideoCapturer;Lg32;Ly6d;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lkob;->b:Ljava/lang/Object;

    .line 4
    iput-object p3, p0, Lkob;->d:Ljava/lang/Object;
...
# virtual methods
.method public a(Lyl;Ltl;)Ljava/lang/Object;
    .locals 9

    const-string v0, "Geo-Position"

    iget-object v1, p0, Lkob;->d:Ljava/lang/Object;
    ...
    invoke-interface {v2, p0, p1, p2}, Ljm;->debugApiRequest(Lsl;Lhm;Ltl;)V

    invoke-virtual {p0, p1, p2}, Lkob;->b(Lyl;Ltl;)Lgge;
    ...
    invoke-interface {v2, p2}, Lh97;->h(Lgge;)Lba7;
    ...
    iget-object v4, v2, Lba7;->c:Ljava/lang/Object;
    ...
    :try_start_2
    iget-object v3, v2, Lba7;->d:Ljava/io/Closeable;

    check-cast v3, Lpk6;

    new-instance v5, Ljava/io/BufferedInputStream;

    iget-object v3, v3, Lpk6;->b:Ljava/lang/Object;
    ...
    invoke-static {v5}, Lyx7;->c(Ljava/io/BufferedInputStream;)Lyx7;
    ...
    invoke-virtual {v4, v5}, Lzs;->a(Ljava/lang/String;)Z

    move-result v5

    if-eqz v5, :cond_0

    iget-object v5, p0, Lkob;->o:Ljava/lang/Object;

    check-cast v5, Llcj;

    invoke-static {v4}, Ly64;->a(Lzs;)V
    ...
    :try_start_4
    iget-object v6, p0, Lkob;->X:Ljava/lang/Object;

    check-cast v6, Ljm;

    invoke-interface {v6, p0, p1, v3}, Ljm;->debugApiResponseOk(Lsl;Lhm;Lxx7;)Lxx7;

    move-result-object v3

    invoke-interface {p1}, Lyl;->getOkParser()Lox7;

    move-result-object v6

    invoke-interface {v6, v3}, Lox7;->parse(Lxx7;)Ljava/lang/Object;
    ...
    :try_start_5
    iget-object p2, p2, Lgge;->d:Ljava/lang/Object;

    check-cast p2, Lzs;

    iget-object p2, p2, Lzs;->b:Ljava/lang/Object;
    ...
    iget-object v8, v7, Lu97;->a:Ljava/lang/String;
    ...
    iget-object v5, v7, Lu97;->b:Ljava/lang/String;
    ...
    :cond_4
    :try_start_6
    invoke-virtual {v2}, Lba7;->close()V
    :try_end_6
    ...
    :cond_9
    :try_start_9
    iget-object p2, p0, Lkob;->X:Ljava/lang/Object;

    check-cast p2, Ljm;

    invoke-interface {p2, p0, p1, v3}, Ljm;->debugApiResponseFail(Lsl;Lhm;Lxx7;)Lxx7;

    move-result-object p2

    invoke-interface {p1}, Lyl;->getFailParser()Lox7;

    move-result-object v0

    invoke-interface {v0, p2}, Lox7;->parse(Lxx7;)Ljava/lang/Object;
    ...
    :try_start_c
    invoke-static {v2, p2}, Lr4j;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Ljm;->debugIoException(Lsl;Lhm;Ljava/io/IOException;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Ljm;->debugApiException(Lsl;Lhm;Lru/ok/android/api/core/ApiException;)V
...
.method public addMediaRecorderToCamera(Landroid/media/MediaRecorder;Lorg/webrtc/CameraVideoCapturer$MediaRecorderHandler;)V
    ...
    iget-object p1, p0, Lkob;->d:Ljava/lang/Object;
    ...
    invoke-interface {p1, p2, v0}, Ly6d;->log(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public b(Lyl;Ltl;)Lgge;
    .locals 13
    ...
    invoke-interface {p1}, Lhm;->getPriority()I

    invoke-interface {p1}, Lhm;->shouldPost()Z
    ...
    invoke-virtual {v1, p1}, Lrl;->b(Lhm;)Landroid/net/Uri;
    ...
    invoke-direct {v7, v8, v9}, Lu97;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v0, v7}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-interface {p1}, Lhm;->shouldGzip()Z
    ...
    invoke-static {v1, v4, v6}, Ldnf;->r(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    iput-object p0, v3, Lpea;->b:Ljava/lang/Object;

    iput-object p1, v3, Lpea;->c:Ljava/lang/Object;

    iput-object p2, v3, Lpea;->d:Ljava/lang/Object;
    ...
    sget-object v8, Lg97;->$EnumSwitchMapping$0:[I
    ...
    invoke-static {v7, v4, v6}, Ldnf;->r(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v1, v2, p1, p2, v9}, Lrl;->g(Ljava/io/OutputStream;Lhm;Ltl;I)V
    ...
    invoke-static {v7, p2, v6, v1}, Lvmf;->C(Ljava/lang/CharSequence;CII)I
    ...
    :goto_3
    invoke-static {v7, p2}, Lho7;->o(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2}, Lwm;->b(Landroid/net/Uri;)Ljava/lang/String;
    ...
    :goto_6
    iget-object p2, p0, Lkob;->c:Ljava/lang/Object;
    ...
    invoke-direct {v2, v3, p2}, Lu97;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lkob;->o:Ljava/lang/Object;
    ...
    invoke-direct {p1, p2, v1}, Lu97;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v10, p2, p1}, Lzs;-><init>(ILjava/lang/Object;)V

    const/4 v12, 0x6

    invoke-direct/range {v7 .. v12}, Lgge;-><init>(Ljava/lang/Comparable;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public initialize(Lorg/webrtc/SurfaceTextureHelper;Landroid/content/Context;Lorg/webrtc/CapturerObserver;)V
    ...
    iput-object v4, p0, Lkob;->o:Ljava/lang/Object;
    :try_end_0
    ...
    :goto_0
    invoke-interface {v1, v3, v0, v4}, Ly6d;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, p0, v2, p3}, Lvhb;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
