...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->X:[Lyy7;
...
.method public constructor <init>(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->a:Leo7;
    ...
    invoke-direct {v0, p0, v1}, Lvmg;-><init>(Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;I)V
    ...
    iput-object p1, p0, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->c:Lka5;
    ...
    invoke-direct {p1, p0, v0}, Lvmg;-><init>(Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;I)V
    ...
    .line 15
    iput-object p1, p0, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->d:Lk18;
    ...
    iput-object p1, p0, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->o:Lbbd;
...
.method public final getInsetsConfig()Leo7;
    ...
    iget-object v0, p0, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->a:Leo7;
...
.method public final getScreenDelegate()Lk1e;
    ...
    iget-object v0, p0, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->c:Lka5;
...
.method public final handleBack()Z
    ...
    invoke-virtual {p0}, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->z0()Lwmg;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget v2, Le0d;->oneme_settings_twofa_onboarding_root:I
    ...
    sget v4, Le0d;->oneme_settings_twofa_onboarding_toolbar:I
    ...
    invoke-virtual {v0}, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->z0()Lwmg;

    move-result-object v6

    sget-object v9, Lwmg;->a:Lwmg;
    ...
    invoke-direct {v10, v11, v0}, Ldse;-><init>(ILjava/lang/Object;)V

    invoke-direct {v6, v10}, Lgfb;-><init>(Lem6;)V
    ...
    sget v6, Le0d;->oneme_settings_twofa_onboarding_scroll_content:I
    ...
    sget v12, Le0d;->oneme_settings_twofa_onboarding_content:I
    ...
    sget v13, Le0d;->oneme_settings_twofa_onboarding_picture_background:I
    ...
    invoke-direct {v13, v15, v7}, Lkt3;-><init>(II)V
    ...
    invoke-direct {v7, v6}, Lnwe;-><init>(Landroid/content/Context;)V

    invoke-virtual {v7, v4}, Lnwe;->d(Z)V
    ...
    sget v13, Le0d;->oneme_settings_twofa_onboarding_picture:I
    ...
    invoke-direct {v13, v14, v5}, Lkt3;-><init>(II)V
    ...
    sget v5, Laxc;->oneme_settings_privacy_cloud_2fa_start_icon:I

    goto :goto_0

    :cond_1
    sget v5, Laxc;->oneme_settings_privacy_cloud_2fa_end_icon:I
    ...
    sget v13, Le0d;->oneme_settings_twofa_onboarding_title:I

    invoke-virtual {v5, v13}, Landroid/view/View;->setId(I)V

    new-instance v13, Lkt3;

    invoke-direct {v13, v4, v8}, Lkt3;-><init>(II)V
    ...
    sget-object v13, Ldpg;->c:Lt5g;

    invoke-static {v13, v5, v2, v5}, Laz1;->f(Lt5g;Landroid/widget/TextView;Lv1a;Landroid/widget/TextView;)Lu3g;
    ...
    sget v13, Lr4d;->oneme_settings_twofa_onboarding_title:I

    goto :goto_1

    :cond_2
    sget v13, Lr4d;->oneme_settings_twofa_onboarding_success_title:I
    ...
    sget v6, Le0d;->oneme_settings_twofa_onboarding_subtitle:I

    invoke-virtual {v13, v6}, Landroid/view/View;->setId(I)V

    new-instance v6, Lkt3;

    invoke-direct {v6, v4, v8}, Lkt3;-><init>(II)V
    ...
    invoke-static {v6, v13, v2, v13}, Laz1;->f(Lt5g;Landroid/widget/TextView;Lv1a;Landroid/widget/TextView;)Lu3g;
    ...
    sget v2, Lr4d;->oneme_settings_twofa_onboarding_description:I

    goto :goto_2

    :cond_3
    sget v2, Lr4d;->oneme_settings_twofa_onboarding_success_description:I
    ...
    invoke-static {v11}, Ll5j;->g(Landroidx/constraintlayout/widget/ConstraintLayout;)Lut3;
    ...
    invoke-virtual {v2, v6, v8, v4, v8}, Lut3;->d(IIII)V

    invoke-virtual {v2, v6, v15, v4, v15}, Lut3;->d(IIII)V

    const/4 v10, 0x6

    invoke-virtual {v2, v6, v10, v4, v10}, Lut3;->d(IIII)V
    ...
    invoke-virtual {v2, v4, v8, v6, v10}, Lut3;->d(IIII)V

    new-instance v6, Lfua;

    const/4 v7, 0x5

    invoke-direct {v6, v2, v8, v4, v7}, Lfua;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v7, v10, v6}, Laz1;->q(FFLfua;)V

    const/4 v6, 0x0

    const/4 v10, 0x6

    invoke-virtual {v2, v4, v10, v6, v10}, Lut3;->d(IIII)V

    new-instance v7, Lfua;

    const/4 v12, 0x5

    invoke-direct {v7, v2, v10, v4, v12}, Lfua;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v14, v10, v7}, Laz1;->q(FFLfua;)V

    invoke-virtual {v2, v4, v15, v6, v15}, Lut3;->d(IIII)V

    new-instance v6, Lfua;

    const/4 v7, 0x5

    invoke-direct {v6, v2, v15, v4, v7}, Lfua;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v6, v7}, Lfua;->e(I)V

    invoke-virtual {v2, v4}, Lut3;->g(I)Lpt3;
    ...
    invoke-virtual {v2, v4, v8, v5, v10}, Lut3;->d(IIII)V

    new-instance v5, Lfua;

    const/4 v6, 0x5

    invoke-direct {v5, v2, v8, v4, v6}, Lfua;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-direct {v5, v2, v10, v4, v7}, Lfua;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v14, v7, v5}, Laz1;->q(FFLfua;)V
    ...
    invoke-direct {v5, v2, v15, v4, v6}, Lfua;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v2, v11}, Lut3;->a(Landroidx/constraintlayout/widget/ConstraintLayout;)V
    ...
    sget v4, Le0d;->oneme_settings_twofa_action:I
    ...
    sget v5, Lr4d;->oneme_settings_twofa_onboarding_set_password:I
    ...
    invoke-direct {v5, v6, v0}, Lpcc;-><init>(ILjava/lang/Object;)V

    invoke-static {v2, v5}, Lf8j;->e(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    new-instance v5, Lhp;

    const/4 v6, 0x7

    invoke-direct {v5, v2, v3, v4, v6}, Lhp;-><init>(Ljava/lang/Object;Ljava/lang/Object;II)V

    invoke-static {v2, v5}, Lmgb;->a(Landroid/view/View;Ljava/lang/Runnable;)Lmgb;
...
.method public final onViewCreated(Landroid/view/View;)V
    ...
    iget-object p1, p0, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->d:Lk18;
    ...
    invoke-direct {v1, v2, p0}, Lxmg;-><init>(Lkotlin/coroutines/Continuation;Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;)V
    ...
    invoke-direct {v0, v2, p0}, Lymg;-><init>(Lkotlin/coroutines/Continuation;Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;)V
...
.method public final y0()Lone/me/sdk/uikit/common/button/OneMeButton;
    ...
    iget-object v1, p0, Lone/me/settings/twofa/creation/onboarding/TwoFAOnboardingScreen;->o:Lbbd;
