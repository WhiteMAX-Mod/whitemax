...
.field public final f:Ls6b;


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILs6b;)V
    .locals 0
    ...
    iput-object p2, p0, Lfp0;->b:Landroid/net/Uri;

    iput-object p3, p0, Lfp0;->c:Landroid/net/Uri;

    iput p4, p0, Lfp0;->d:I

    iput p5, p0, Lfp0;->e:I

    iput-object p6, p0, Lfp0;->f:Ls6b;
...
.method public final a(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lfp0;->c:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v2, p0, Lfp0;->a:Landroid/content/Context;
    ...
    :cond_0
    invoke-static {v2}, Lgvi;->b(Ljava/io/Closeable;)V

    invoke-static {p1}, Lgvi;->b(Ljava/io/Closeable;)V

    iput-object v0, p0, Lfp0;->b:Landroid/net/Uri;
    ...
    :goto_1
    invoke-static {v1}, Lgvi;->b(Ljava/io/Closeable;)V
...
.method public final b(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    invoke-virtual {v1, p1}, Lsua;->b(Lzmd;)Lmbd;
    ...
    :try_start_2
    iget-object v5, p0, Lfp0;->a:Landroid/content/Context;
    ...
    sget-object v5, Lyua;->a:Ljava/util/logging/Logger;
    ...
    :try_start_3
    invoke-interface {v4, v5}, Lwv0;->H(Lux;)J
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    invoke-static {v4}, Lgvi;->b(Ljava/io/Closeable;)V

    invoke-static {v5}, Lgvi;->b(Ljava/io/Closeable;)V

    invoke-static {v1}, Lgvi;->b(Ljava/io/Closeable;)V

    invoke-virtual {v2}, Lfa6;->r()V
    ...
    :goto_2
    invoke-static {v3}, Lgvi;->b(Ljava/io/Closeable;)V

    invoke-static {v5}, Lgvi;->b(Ljava/io/Closeable;)V

    if-eqz p1, :cond_1

    iget-object p1, p1, Lood;->Y:Lqod;
...
.method public final c()Ljava/lang/String;
    ...
    iget-object v1, p0, Lfp0;->a:Landroid/content/Context;

    invoke-static {v1, v0}, Lz7;->b(Landroid/content/Context;Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lfp0;->b:Landroid/net/Uri;
    ...
    invoke-static {v1, v0, v2, v2}, Lmbj;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v3, v0}, Lmbj;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public final d()Lep0;
    ...
    iget-object v3, v1, Lfp0;->a:Landroid/content/Context;

    iget-object v0, v1, Lfp0;->b:Landroid/net/Uri;
    ...
    invoke-direct {v0, v2}, Lep0;-><init>(Ljava/lang/Exception;)V

    return-object v0

    :cond_0
    :try_start_0
    invoke-virtual {v1}, Lfp0;->e()V
    :try_end_0
    ...
    iget-object v4, v1, Lfp0;->b:Landroid/net/Uri;
    ...
    :cond_1
    iget v12, v1, Lfp0;->d:I

    iget v13, v1, Lfp0;->e:I
    ...
    invoke-direct {v3, v0}, Loe7;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v3}, Loe7;->a()I
    ...
    :try_start_4
    invoke-static {v0}, Lgvi;->b(Ljava/io/Closeable;)V
    :try_end_4
    ...
    iput v11, v4, Lik5;->b:I

    iput v10, v4, Lik5;->c:I
    ...
    :cond_b
    :goto_7
    invoke-direct {v3, v13, v4}, Lep0;-><init>(Landroid/graphics/Bitmap;Lik5;)V
    ...
    invoke-direct {v0, v13, v4}, Lep0;-><init>(Landroid/graphics/Bitmap;Lik5;)V
    ...
    invoke-direct {v2, v0}, Lep0;-><init>(Ljava/lang/Exception;)V
...
.method public final e()V
    ...
    iget-object v3, p0, Lfp0;->c:Landroid/net/Uri;
    ...
    iget-object v0, p0, Lfp0;->a:Landroid/content/Context;
    ...
    :try_start_0
    iget-object v1, p0, Lfp0;->b:Landroid/net/Uri;
    ...
    invoke-virtual {p0}, Lfp0;->c()Ljava/lang/String;
    ...
    iput-object v1, p0, Lfp0;->b:Landroid/net/Uri;
    :try_end_1
    ...
    invoke-virtual {p0, v1, v3}, Lfp0;->a(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_2
    ...
    iget-object v2, p0, Lfp0;->b:Landroid/net/Uri;
    ...
    invoke-static {v2, v0}, Lwy1;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v3}, Lfp0;->b(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_7
...
.method public final onPostExecute(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lep0;->b:Ljava/lang/Exception;

    iget-object v1, p0, Lfp0;->f:Ls6b;

    if-nez v0, :cond_1

    iget-object p1, p1, Lep0;->a:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iget-object v1, v1, Ls6b;->a:Ljava/lang/Object;

    check-cast v1, Lahg;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, v1, Lahg;->z0:Ljava/lang/String;

    const/4 v0, 0x1

    iput-boolean v0, v1, Lahg;->w0:Z

    invoke-virtual {v1, p1}, Lahg;->setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    iget-object p1, v1, Ls6b;->a:Ljava/lang/Object;
