...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lyg1;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    return-void
.end method

.method public constructor <init>(Ly6d;Landroid/opengl/EGLContext;[ILts9;Ljava/lang/String;)V
    .locals 13

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lyg1;->a:Ly6d;

    move-object/from16 v0, p4

    iput-object v0, p0, Lyg1;->b:Lts9;
    ...
    iput-object v0, p0, Lyg1;->c:Landroid/os/HandlerThread;

    sget-object v1, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    iput-object v1, p0, Lyg1;->g:Landroid/opengl/EGLSurface;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lyg1;->h:Ljava/lang/Object;
    ...
    :goto_1
    iput-object v2, p0, Lyg1;->j:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, p1, v4, v5}, Lvba;-><init>(Landroid/os/Looper;Ly6d;Ljava/lang/String;Ljx0;)V

    iput-object v3, p0, Lyg1;->k:Lvba;
    ...
    invoke-interface {p1, v2, p2}, Ly6d;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {v0, p0, v5, p2, v4}, Lcj;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final b(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lyg1;->d:Landroid/opengl/EGLContext;

    if-eqz v0, :cond_3

    iget-object v1, p0, Lyg1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v3, p0, Lyg1;->d:Landroid/opengl/EGLContext;
    ...
    iget-object v2, p0, Lyg1;->g:Landroid/opengl/EGLSurface;
    ...
    iput-object p1, p0, Lyg1;->g:Landroid/opengl/EGLSurface;
...
.method public final c(Lem6;)Z
    .locals 3

    :try_start_0
    iget-object v0, p0, Lyg1;->k:Lvba;

    new-instance v1, Lxg1;

    const/4 v2, 0x1

    invoke-direct {v1, p1, p0, v2}, Lxg1;-><init>(Lem6;Lyg1;I)V
    ...
    iget-object v0, p0, Lyg1;->j:Ljava/lang/String;

    const-string v1, "OpenGL tread died, is it fine?"

    iget-object v2, p0, Lyg1;->a:Ly6d;
...
.method public final d(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lyg1;->e:Landroid/opengl/EGLDisplay;

    if-eqz v0, :cond_0

    invoke-static {v0, p1}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    sget-object p1, Lyg1;->l:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lyg1;->a:Ly6d;

    iget-object v1, p0, Lyg1;->j:Ljava/lang/String;
